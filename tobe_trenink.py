...
class ToBeTrainerApp:
    def __init__(self, master):
        ...
        if not self.verb_rows:
            messagebox.showerror("Chyba", "V souboru verb_conjugation.csv nejsou žádná data.")
            self.master.destroy()
            return
        ...
        self.btn_positive.grid(row=0, column=1, padx=15)
        ...
        self.btn_negative.grid(row=0, column=2, padx=15)
        ...
        self.btn_verconjug.grid(row=0, column=3, padx=15)
