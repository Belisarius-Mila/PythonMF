...
class ColorsAndNumbersApp:
    ...
    def _show_owl_easter_egg_once(self):
        ...
        phrase = (
            "Zdravím Vás opět, Katko, Jano, Markéto, Simčo, doufám, že jste v plném počtu. "
            "Stále sleduji Vaše studium. "
            "Výborně, jen tak dál. Také to duolingo je super,že děláte. "
            "Mrkněte na ta čísla, ať už je zvládnete na jedničku. "
            "Hlavně opakovat a opakovat a neusnout na vavřínech. "
            "Hůhůhů."
        )
        ...
        self.owl_hide_after_id = self.master.after(23500, self._hide_owl_overlay)
