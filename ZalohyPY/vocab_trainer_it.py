    ...
    if getattr(sys, "frozen", False):
        ...
        with open(target_csv, "w", encoding="utf-8", newline="") as f:
            writer = csv.DictWriter(
                f, fieldnames=["IT", "CZ", "Order", "Sentence", "SentenceT", "L", "HT"]
            )
            writer.writeheader()
        return target_csv
...
class VocabularyTrainerApp:
    ...
    def _write_rows(self, rows):
        fieldnames = ["IT", "CZ", "Order", "Sentence", "SentenceT", "L", "HT"]
    ...
    def export_actual_words_image(self):
        ...
        draw.text((x_it, y), "IT", font=title_font, fill="black")
    ...
    def open_input_window(self):
        ...
        columns = ("Order", "IT", "CZ", "Sentence", "SentenceT", "L", "HT")
        tree = ttk.Treeview(
            list_frame,
            columns=columns,
            show="headings",
