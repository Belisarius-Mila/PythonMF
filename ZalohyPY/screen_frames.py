...
class FlashcardsScreen(ctk.CTkFrame):
    ...
    def __init__(
        ...
        self.asset_index = asset_index or build_asset_index(Path(__file__).resolve().parent / "Foto_normalized")
    ...
    def _build_ui(self) -> None:
        ...
        for _ in range(3):
            btn = ctk.CTkButton(self.quiz_options_frame, text="-", command=lambda: None, height=48)
...
class WeekdaysScreen(ctk.CTkFrame):
    ...
    def _build_writing_mode(self) -> None:
        ...
        for card in self.cards:
            ...
            entry = tk.Entry(row, width=24, relief="flat", highlightthickness=1, bd=0)
