...
NONCACHED_SCREEN_KEYS = {"weekdays", "months"}
ICON_SIZE = (112, 112)
ICON_TOP_PADDING = 10
COCKPIT_ICON_DIR = Path(__file__).resolve().parent / "cockpit_icons"
COCKPIT_ICON_FILES = {
...
class CockpitApp(ctk.CTk):
    def __init__(self, bundle: DataBundle) -> None:
        ...
        self.flash_asset_index = build_asset_index(Path(__file__).resolve().parent / "Foto_normalized")
