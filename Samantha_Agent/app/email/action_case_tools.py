...
@function_tool
def build_email_action_case_from_uid(
    uid: str,
    user_confirmed: bool = False,
    confirmation_text: str = "",
    max_chars: int = 4_000,
) -> str:
    """Build a redacted reminder-task draft from one email UID after confirmation."""
    return build_email_action_case_from_uid_text(
        uid=uid,
...
def build_email_action_case_from_uid_text(
    uid: str,
    user_confirmed: bool = False,
    confirmation_text: str = "",
    max_chars: int = 4_000,
    ...
    if not user_confirmed or not has_explicit_read_confirmation(
        ...
        return (
            ...
            "e-mailu pro vytvoreni navrhu ukolu. Bez toho telo zpravy nectu."
        )
    ...
    try:
        ...
        return f"Vytvoreni navrhu ukolu z e-mailu selhalo: {exc}"

    action_case = build_email_action_case(message)
    return format_email_action_case(action_case)
