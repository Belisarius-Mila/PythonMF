...
**Stav: 0.2.0 (2) nainstalováno/spuštěno; krátký test zámku a T016 PASS podle Míly, další fyzická přejímka čeká.**
...
| T016 | 30 minut převážně pod zámkem, průběžné neosobní zvukové značky; Stop a celý poslech, skutečná délka/velikost. Jediný soubor v C01b není důkaz segmentace C01c. | PASS podle Míly 2026-09-16: přibližně 30:16, režim Letadlo, nahrávání pod zámkem bez problému a celý záznam přehratelný. Velikost souboru nebyla sdělena; přehrávání při zamčené obrazovce neběželo, což není kritérium T016. |
