# Camino — akceptační scénáře v0.4

**Datum:** 14. září 2026. **Stav všech níže uvedených scénářů:** NEPROVEDENO. Jde o zadání testů, nikoli zprávu o funkčnosti aplikace.

Navazuje na `CAMINO_funkcni_specifikace_v0.4.md`. Značky F odkazují na její funkční pravidla. **A** = automatizovatelný test logiky, **I** = integrační test procesů a úložišť, **D** = skutečné zařízení / fyzická zkouška. Kombinace znamená, že softwarový test nenahrazuje zařízení.
...
P0 musí mít doložené výsledky T001–T071 a T078–T080 v rozsahu relevantním skutečné implementaci; test může mít automatickou i manuální část. T072–T076 jsou další povinná brána před zpřístupněním P1. T077 je souhrnná brána P2 a před vlastní implementací filmu se rozpadne na podrobné samostatné scénáře.
