...
**Stav: autoritativní podklady v0.5 + U15. C01a, C01b, C01c a C02a jsou přijaty v prototypovém rozsahu. C02b je zahájené: lokální receiver částí a Swift model pravdivé fronty jsou připravené, ale skutečný URLSession klient a fyzické T043/T047–T050 ještě ne. Trvalá služba ani veřejná cesta nejsou aktivní. Camino Viewer je P0, ale podle etap se implementuje až v C08c–C08f.**
...
- [První report C02b](docs/C02b_CHUNK_TRANSFER_REPORT.md)
- [Audio prototyp](prototypes/audio/README.md)
- [Transfer core C02b](prototypes/transfer/README.md)
- [Aktuální report a překážky](docs/C01a_AUDIO_PROTOTYPE_REPORT.md)

C02b je zahájené prvním lokálním checkpointem pro 8MiB části, obnovu chybějících
částí a pravdivé klientské stavy. Další krok je nativní iOS `URLSession` harness;
bez něj nejsou fyzické T043/T047–T050 PASS. C02a/C02b receiver není produkční
upload server.
