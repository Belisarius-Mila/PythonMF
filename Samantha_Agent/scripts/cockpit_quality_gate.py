...
COMPILE_PATHS = (
    ...
    "app/library_photo_compaction.py",
    "app/article_archive.py",
    "app/cockpit_readonly_routes.py",
    "app/cockpit_document_routes.py",
    "app/cockpit_email_archive_routes.py",
    ...
    "app/camino_receiver.py",
    "app/camino_chunk_receiver.py",
    "camino/domain/__init__.py",
    "camino/domain/model.py",
    "camino/domain/codec.py",
    "camino/domain/audio_layout.py",
    "camino/domain/revision_store.py",
    "camino/api/__init__.py",
    "camino/api/v1.py",
    "camino/server/__init__.py",
    "camino/server/admin.py",
    "camino/server/application.py",
    "camino/server/auth.py",
    "camino/server/main.py",
    "camino/server/service_safety.py",
    ...
    "scripts/camino_service_network.py",
    ...
    "scripts/build_quick_note_github_shortcut.py",
...
TEST_MODULES = (
    ...
    "tests.test_library_photo_compaction",
    "tests.test_article_archive",
    "tests.test_cockpit_readonly_routes",
    "tests.test_cockpit_document_routes",
    "tests.test_cockpit_email_archive_routes",
    "tests.test_cockpit_server",
    "tests.test_cockpit_status_service",
    "tests.test_camino_receiver",
    "tests.test_camino_chunk_receiver",
    "tests.test_camino_domain",
    "tests.test_camino_viewer",
    "tests.test_camino_viewer_runtime",
    "tests.test_camino_audio_layout",
    "tests.test_camino_service_control",
    "tests.test_camino_service_network",
    "tests.test_camino_recovery",
    "tests.test_camino_c03b_contract",
    "tests.test_camino_c05a_media_store",
    "tests.test_camino_c05a_loopback_smoke",
    "tests.test_camino_c02b_t043_control",
    "tests.test_camino_c05b_private_control",
    ...
    "tests.test_github_quick_notes",
    "tests.test_quick_note_github_shortcut",
