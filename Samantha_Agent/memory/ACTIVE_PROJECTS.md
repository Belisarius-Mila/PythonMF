...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b 2026-09-19 18:06 CEST: T043/T047/T050 PASS v syntetickém fyzickém rozsahu; T049 prošel syntetickou mobilní částí. Druhý T050 běh zachytil současné telefonní `Ověřuji` a serverové `verifying` bez účtenky, pak jediný ověřený objekt; oba T050 běhy bezpečně ukončené, Funnel vypnutý. Automatický start po návratu aplikace je otevřená UX výhrada. T048 na cizí Wi-Fi a plné T049 se skutečným videem zůstávají otevřené. Přípravná brána 1719/1719 PASS, při fyzickém testu neopakovaná. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Až bude dostupná cizí Wi-Fi, provést T048; před dalším mobilním během vyjasnit automatický start čerstvé dávky. |
