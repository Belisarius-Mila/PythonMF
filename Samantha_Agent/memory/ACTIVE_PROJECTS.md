...
| iCloud Mail read-only / Email Cases | 1 | active | Read-only e-mailové workflow a Work Queue jsou funkční. UX0+UX1 mění Archiv e-mailu na přehled ve stylu schránky: seznam zpráv, hledání, filtr příloh, lidský detail s bezpečně omezeným textem a sjednocené odkazy na dostupné přílohy. Implementace a plná brána jsou hotové, ale změna zatím není nasazená ani vizuálně potvrzená v prohlížeči. | `projects/email_readonly_oauth.md` | `handoffs/cockpit_email_archive_browser_2026_07_09.md` | Po samostatném potvrzení nasadit aktuální `main`, spustit smoke test a ručně ověřit desktop i iPhone: seznam, detail, návrat, hledání a otevření známé PDF přílohy. Zápisy, mazání a odesílání zůstávají mimo rozsah. |
