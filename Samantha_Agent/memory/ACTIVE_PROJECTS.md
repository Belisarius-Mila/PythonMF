...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C03b 2026-09-20 08:50 CEST: lokální owner API v1 a SQLite revize/účtenky/konflikty; 12 syntetických kontraktních testů a plná brána 1740/1740 PASS. Bez listeneru, iPhone a produkční integrace. C03a a U15 zůstávají referenční. C02b T043/T047/T050 prošly synteticky; build 4 má fyzický PASS části A a částečnou část B, T049 potvrzeně zastavené se zachovaným důkazem a vypnutým Funnelem. T048 na cizí Wi-Fi a plné T049 se skutečným videem zůstávají otevřené. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Po samostatném zadání C04a místní úložiště; C05a produkční server a média. T048 odděleně při dostupné cizí Wi-Fi. Plné T049 až v integrované aplikaci. |
