...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b fyzická příprava 2026-09-17 20:15 CEST: harness 0.4.0 (1) je na iPhonu. Dva starty bezpečně vrátily trasu: první odhalil kolizi `app/email`, druhý chybějící Python CA řetězec. Modulový entrypoint a explicitní systémový CA bundle jsou opravené; plná brána 1711/1711 PASS. Fyzické T043/T047–T050 jsou NEPROVEDENO a Serve cesta/receiver neběží. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Zopakovat už potvrzený `camino_c02b_t043_start`, vložit URL a token do harnessu a řízeně přerušit/obnovit síť u T043; Funnel nezapínat. |
