...
| MMTX | 1 | active | Obsahově dorovnáno 2026-08-29 15:43 CEST. Webová scéna 3 od 2026-08-26 pokračuje přímo do Harryho scény 4 a skrytý rychlý přechod vede rovněž k Harrymu. Historický stav samostatného prototypu už není aktuální. Otevřeno: české a další nepokryté systémové čtení Harryho scény je na Linuxu nekvalitní a má být nahrazeno pevnými MP3. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Udělat úplnou inventuru mluvených řetězců Harryho scény, doplnit pevná MP3 a ručně ověřit průchod scéna 3 → Harry na Linuxu i Macu. |
...
| Linux / instalace a konfigurace | 2 | active | Checkpoint 2026-08-29 16:22 CEST. Hotovo: Harryho scéna nyní přehrává všech 136 anglických a českých dialogových a slovníkových stop z předem připravených MP3 bez systémového hlasu.; Předchozí stav main byl před tímto checkpointem serverově nasazený a ověřený. Otevřeno: Pozdější nasazení nového checkpointu zatím není tímto snapshotem doložené.; Lokální commity čekají na samostatný denní GitHub balíček. Rizika: Žádné další doložené provozní riziko. | `projects/linux_workstation.md`; `WORKSTREAMS.md` | zatím nematerializováno; stabilní lazy cesty `handoffs/workstreams/project-linux-workstation.md`; `tvbcp/workstreams/project-linux-workstation.md` | Ručně poslechnout celý průchod Harryho scénou na Linuxu a ověřit přirozenost hlasů i tempo. |
