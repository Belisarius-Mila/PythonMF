...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b 2026-09-17 21:23 CEST: T043 PASS v syntetickém rozsahu; po testu je receiver zastavený, `/camino-c02b` odebraná, Serve přesně obnovený a Funnel vypnutý. Tři ověřené Assety jsou zachované. Harness 0.4.0 (2) zůstává na iPhonu. Oddělený T047 workflow s auditem relací a hashů částí je připravený, ale neaktivní; plná brána 1716/1716 PASS a fyzické T047–T050 čekají. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Po samostatném potvrzení spustit `camino_c02b_t047_start`; T047 provést nejprve pod zámkem a potom na nové dávce force quit s ručním relaunch. |
