...
| MMTX | 1 | active | Produkce ověřena 2026-08-29 21:01 CEST. Scény 2 a 3 používají pevné anglické a české MP3 bez systémového hlasu. Opravený Human–Adam živým `p+n` publikoval commit `0230cf5` přes run `33269734786`, deployment `6159053676` a HTTP 200. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Prakticky projít a poslechnout scény 2 a 3 na Linuxu; další dokončení ukončit samoobslužným `p+n`. |
