...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02a dokončené v prototypovém rozsahu 2026-09-17 15:19 CEST. Privátní HTTPS smoke přes dočasnou Tailscale Serve cestu ověřil serverový hash a délku, právě jeden objekt a účtenku, chybný hash, konflikt a retry bez duplicity. Funnel zůstal vypnutý, Cockpit dostupný a původní Serve konfigurace byla obnovena. Otevřeno: iPhone/cizí síť, velký soubor a úplné T043/T048/T051 patří do C02b. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Vyčkat na výslovný pokyn k C02b: velký soubor, souborové části a chování iOS na cizí síti bez veřejného endpointu. |
