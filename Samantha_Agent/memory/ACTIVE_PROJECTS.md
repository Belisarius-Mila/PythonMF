...
| MMTX | 1 | active | Checkpoint 2026-08-16 22:15 CEST. Hotovo: Harry po posledním výslechu dovolí přátelům pokračovat otevřenou brankou; Předchozí stav main byl před tímto checkpointem serverově nasazený a ověřený. Otevřeno: Pozdější nasazení nového checkpointu zatím není tímto snapshotem doložené.; Lokální commity čekají na samostatný denní GitHub balíček. Rizika: Žádné další doložené provozní riziko. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Ověřit závěrečnou repliku, hlas a přechod do dokončené scény na iPhonu |
