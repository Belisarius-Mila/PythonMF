...
| Samantha Agent/RAG | 1 | active | P0 zavedlo read-only audit pravdivosti 30 pracovnich proudu. P1 pridalo autoritu zdroju `canonical`, `aggregate`, `aggregate_unverified`, `reference` a `historical`, omezenou na proud rozpoznany z dotazu; cilene testy 21/21 a nasazeni se smoke 5/5 prosly. P2 po vyslovnem souhlasu zalozilo jednu kanonickou dvojici pro tento proud. P3 opravilo jediny prokazany formalni rozpor Mobile Input a opakovany audit hlasi nula rozporu. | `samantha_core.md`; `tvbcp/workstreams/project-samantha-agent-rag.md` | `handoffs/workstreams/project-samantha-agent-rag.md` | P4 ma read-only overit prakticke dotazy pro sedm proudu soucasne roadmapy a sledovat volbu autority i `source_type`; embeddings zatim nepridavat. |
