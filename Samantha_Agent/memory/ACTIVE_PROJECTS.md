...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | Checkpoint 2026-09-17 14:19 CEST. Hotovo: Lokální C02a přijímač bezpečně ověřuje syntetický soubor serverovým hashem bez přepisu či duplicit; Předchozí stav main byl před tímto checkpointem serverově nasazený a ověřený. Otevřeno: Pozdější nasazení nového checkpointu zatím není tímto snapshotem doložené. Rizika: Žádné další doložené provozní riziko. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Po checkpointu autorizovat privátní HTTPS smoke přes Tailscale Serve se syntetickým souborem |
