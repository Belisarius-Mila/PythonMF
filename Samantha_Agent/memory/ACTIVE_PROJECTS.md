...
| Cockpit hlavni architektura / modernizace | 1 | active | AuditCockpit56_2 v1.9: dokumentové čtecí HTTP rozhraní oddělené lokálně; 61 shodných kontraktů, 35 cílených testů, plná brána 1665/1665. Hlavní cockpit.py menší o 91 řádků. Bez nového push/nasazení; předchozí Git optimalizace nasazená v fc889ed5. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | Samostatné vydání a společná Mac/iPhone přejímka čteček; pak další strukturální řez a navazující audit/UI. |
