...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | Založený projekt a katalogový proud Human–Adam; podklady v0.4 zachované. Aplikace ani audit C00 zatím nevznikly. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Nejdřív meziúkol podle Míly, potom C00: read-only audit prostředí. |
