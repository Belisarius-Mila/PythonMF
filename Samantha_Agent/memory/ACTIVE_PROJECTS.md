...
| Cockpit hlavni architektura / modernizace | 1 | active | AuditCockpit56_2 v1.5: lokální hledání, čtečky, měření brány a dokončený pilot přípravy deploy testů. Příprava 87 → 53 Git procesů; osm původních běhů a nový test izolace prošly. Plná brána po změně 1650/1650 prošla; unit 455,34 s, deploy skupina 18 testů / 84,49 s. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | Čtyři lokální kroky čekají na společný push/nasazení na samostatný pokyn. Další strukturální řez podle HTTP/doménové vazby; Mac/iPhone přejímka a navazující audit/UI zůstávají otevřené. |
