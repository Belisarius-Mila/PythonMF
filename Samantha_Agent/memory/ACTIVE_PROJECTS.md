...
| Cockpit hlavni architektura / modernizace | 1 | active | Lokálně doplněný přehled screenů a potvrzované uzavření s ochranou Codexu, služeb a čerstvé identity. Cílené testy 28/28 i skutečný prohlížečový test prošly; plná brána a požadovaný push/nasazení čekají na dokončení. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | Dokončit plnou bránu, push, řízené nasazení a živé ověření v project-cockpit. |
