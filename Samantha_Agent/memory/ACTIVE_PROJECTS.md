...
| Znalostni databaze / Knihovna clanku / Knowledge inbox | 2 | active | 2026-09-12: nové fotografie celkem do 305 KiB včetně náhledu; c+p+n probíhá. Převod 22 starých obrázků 59,117 → 5,962 MiB připraven a vizuálně ověřen, čeká na přesnou větu globální brzdy. | `projects/vedecke_clanky.md`; `technical/large_context_intake.md`; `tvbcp/knihovna_cockpit.txt` | `handoffs/knowledge_library_article_editing_2026_07_16.md` | Dokončit c+p+n; po přesném potvrzení převést 22 existujících fotografií |
