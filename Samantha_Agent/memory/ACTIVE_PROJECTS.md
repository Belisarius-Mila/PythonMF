...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b 2026-09-18 08:29 CEST: T043 i T047 PASS v syntetickém rozsahu. T047 má 2 relace, 2 ověřené objekty/účtenky po 100 663 553 B, relaunch po force quit doplnil jen chybějící části. T047 receiver je ukončený, `/camino-c02b` odebraná, Serve přesně obnovený a Funnel vypnutý; T048–T050 čekají. Plná brána 1716/1716 PASS. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Provést T048–T050 odděleně. |
