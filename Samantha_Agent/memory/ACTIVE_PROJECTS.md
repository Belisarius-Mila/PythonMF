...
| MMTX | 1 | active | Dorovnáno 2026-08-29 17:30 CEST. Harryho scéna na produkci přehrává všech 136 anglických a českých dialogových a slovníkových stop z pevných MP3 bez `speechSynthesis`; veřejná Pages publikace odpovídá commitu `f1499b1`. Míla prakticky potvrdil, že přizpůsobení na Linux PC funguje dobře; tento milník nemá známý otevřený blokátor. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Pokračovat dalším vývojovým krokem v aktivním Human–Adam proudu `project-mmtx`; retest na Macu je volitelný jen pro ověření konkrétního rozdílu platformy. |
