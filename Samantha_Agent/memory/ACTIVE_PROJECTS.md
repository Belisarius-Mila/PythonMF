...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C04a 2026-09-20: první samostatná iPhone aplikace s offline Trip/Day/Moment, značkou, dnešním přehledem a C01c audiem; soukromí D02/U15 v místních datech. Swift 8/8, UI simulátoru 1/1, nepodepsaný iOS build PASS. Fyzický iPhone, Mac synchronizace a Viewer neověřené. C03b zůstává referenčním API bez provozního napojení. C02b T043/T047/T050 prošly synteticky; T048 a plné T049 zůstávají otevřené, T049 receiver zastavený a Funnel vypnutý podle posledního potvrzeného stopu. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | C04b foto/video; fyzicky ověřit C04a před přijetím hardware chování. C05a pak produkční server a média. T048 odděleně při dostupné cizí Wi-Fi. |
