...
| Cockpit hlavni architektura / modernizace | 1 | active | AuditCockpit56_2 v1.12: HTTP moduly vydané v 088f725c, CI a smoke 5/5 zelené. Přejímka odhalila neposouvatelný archiv jen na Macu; opraveno dvěma CSS deklaracemi, desktopový browser před/po a mobil ověřené, 24 cílených testů. Opravné vydání ověřit živě. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | Krátký retest posouvání archivu na Macu/iPhonu po opravném vydání; audit UI později samostatně. |
