...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | M1 náhled potvrzen; M2a/M2b a M2c lokálně hotové. `camino/docs/M2c_SERVICE_REPORT.md`: ovládání služby, snapshot před schématem 3, explicitní grant/odvolání Vieweru. Offline 17/17, server 22/22 PASS. Bez nasazení/tokenů/launchd/sítě/telefonu; nová konfigurace chybí. Živý RT3/RT4 a restart otevřené. M3/M4, U15 zachované, AI odložená; SideStore kontrola 1. 10. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Schválit nasazovací přípravu a výběr stávajícího archivu; potom server, podepsaná aktualizace a jeden společný průchod. |
