...
| MMTX | 1 | active | Produkce ověřena 2026-08-29 19:52 CEST. Scény 2 a 3 používají pevné anglické a české MP3 bez systémového hlasu a Pages run `33266361424` je publikoval z commitu `933834f`. Veřejné manifesty a vzorky MP3 jsou hashově shodné. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Prakticky projít a poslechnout scény 2 a 3 na Linuxu; další dokončení po živém ověření ukončit samoobslužným `p+n`. |
...
- 2026-08-29 19:52 CEST: Priorita 1, Human–Adam / samoobslužné MMTX `p+n`.
  ...
  deploymentu a HTTP smoke. Cílená sada prošla 156/156 a úplná brána 1475/1475;
  před dokončením zbývá commit, push, nasazení Cockpitu a živý test. Handoff:
