...
| App-server rozhrani / novy Adam | 1 | active | Nasazení 2026-08-31 12:04 CEST. Hotovo: `gpt-transcribe-migration` z commitu `bee5ad5` běží v Cockpitu; nový proces má potvrzený kódový otisk, serverový smoke 5/5 a post-deploy syntetický český přepis přes skutečný Human–Adam endpoint vrátil přesný očekávaný text. Otevřeno: pouze krátký skutečný uživatelský hlasový retest; GitHub push zůstává v denním balíčku. Rizika: Klíčová slova jsou pouze nápověda a při živém retestu je třeba hlídat, že model nevloží nevyslovený termín. | `tvbcp/architektura_komunikace_samantha.txt`; `technical/project_tvbcp_rules.md`; `technical/global_safety_brake.md`; `technical/capability_routing_rules.md` | `handoffs/human_adam_layer_workstream_start_2026_07_20.md` | V Cockpitu jednou nahrát krátký skutečný český pokyn, zkontrolovat přepis v editoru a teprve ručně odeslat |
