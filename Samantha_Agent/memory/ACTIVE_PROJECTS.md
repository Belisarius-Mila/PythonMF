...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | [PRIPOMENOUT] Opravená verze aktualizována a spuštěna na iPhonu; 32 testů jádra a 2 UI testy simulátoru OK. Ruční retest čeká. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | V otevřeném Caminu přehrát existující vzorek a ověřit běžící čas, modrý průběh, Stop a opakované přehrání. Potom doplnit metadata neutrálních vzorků a první odmítnutí oprávnění; C01b nezahajovat. |
