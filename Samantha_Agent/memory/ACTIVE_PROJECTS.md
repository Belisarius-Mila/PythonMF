...
| MMTX | 1 | active | Checkpoint 2026-08-15 11:11 CEST. Hotovo: Závěr prototypu nabízí slovníček 22 nových slov s anglickou výslovností a volitelnou češtinou; Předchozí stav main byl před tímto checkpointem serverově nasazený a ověřený. Otevřeno: Pozdější nasazení nového checkpointu zatím není tímto snapshotem doložené. Rizika: Žádné další doložené provozní riziko. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Ručně ověřit slovníček, jeho rozložení a výslovnost na iPhonu |
...
| Cockpit Recovery centrum | 1 | active | Recovery, health, diagnostika, bezpečný restart, Tailscale přístup a pamatováček jsou funkční. Dne 2026-08-15 bylo po přesném potvrzení odstraněno 144 starých časovaných autosave souborů; zůstalo 12 nejnovějších časů, všechny `latest` kopie, jeden watcher a přibližně 1,30 GiB autosave dat. Odhad cleanupu byl logický, nikoli fyzický APFS zisk; CloudKit ani jiná data se nemazala. | `infrastructure/codex_reconnect_recovery.md`; `infrastructure/klicove_prikazy_pamatovacek.md`; `technical/session_recovery_rules.md`; `LESSONS_LEARNED.md` | `handoffs/autosave_cleanup_ssd_space_recovery_2026_08_15.md`; `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_startup_health_voicebridge_verified_2026_07_09.md` (historický základ) | [PRIPOMENOUT] Po restartu spustit `samantha`, připomenout aktualizaci `AuditCockpit56_Mila.txt`, znovu read-only změřit SSD/autosave/VM/CloudKit a potom opravit matematiku Cockpitu. Nejdřív vyjasnit, zda `_Mila` znamená nový soubor, protože nyní existuje jen `AuditCockpit56.txt`. |
