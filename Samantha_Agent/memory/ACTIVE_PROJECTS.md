...
| Cockpit hlavni architektura / modernizace | 1 | active | U01–U04 lokálně hotové; hledání má stránkování, rozsah výsledků a ochranu před opožděnou odpovědí. Audit v2.4; 27 cílených testů, čtyři browser scénáře a plná brána 1677 testů OK. Bez nového nasazení. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | U05 prioritní fronta a provozní stav. Push/nasazení a fyzická přejímka samostatně. |
