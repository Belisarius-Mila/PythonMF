...
| Cockpit hlavni architektura / modernizace | 1 | active | AuditCockpit56_2 v1.4: hledání a čtečky lokálně oddělené, třetí čekající krok přidává měření brány. Aktuální plná brána 1649/1649 za 426,38 s; čtyři Git/workspace skupiny tvoří 73,5 % času. Report a návrh pilotu uložené. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | Společný push/nasazení tří kroků odložený. Případný pilot zrychlení: rozdělit cenu přípravy a Git operací dvou nejpomalejších deploy testů; zachovat plnou bránu. |
