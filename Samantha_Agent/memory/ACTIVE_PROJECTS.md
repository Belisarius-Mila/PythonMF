...
| Samantha Infrastructure | 1 | active | 2026-09-12: první balíček instrukcí zjednodušen; handoff/TVBCP a oprávnění zachovány. CLI a App Server 0.154.0 servisně ověřeny. Serverové prompty jsou samostatný další krok. | `infrastructure/operating_model.md`; `technical/global_safety_brake.md`; `technical/session_recovery_rules.md`; `technical/project_tvbcp_rules.md`; `tvbcp/workstreams/project-samantha-infrastructure.md` | `handoffs/workstreams/project-samantha-infrastructure.md` | Posoudit nové instrukce při další práci; samostatně sladit serverové prompty Human–Adam. |
