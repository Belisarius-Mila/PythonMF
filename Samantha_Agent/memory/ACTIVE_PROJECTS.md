...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b 2026-09-19 21:34 CEST: T043/T047/T050 PASS v syntetickém fyzickém rozsahu; T049 prošel syntetickou mobilní částí. Oba T050 běhy bezpečně ukončené, Funnel vypnutý. Build 0.4.0 (4) na Macu přidal vědomý první start nové dávky s mobilním grantem a zachoval obnovu rozpracované dávky; Swift 22/22, simulátorový UI test a nepodepsaný iOS build PASS. Schválené p+n funkčního balíčku: GitHub 17 commitů po plné bráně 1719/1719, řízené nasazení Cockpitu `4a965ccb` s novým procesem a smoke 5/5; konečný dokumentační checkpoint ověřit živě. Build 4 je podepsaný a nainstalovaný na iPhonu; cílený fyzický test nového prvního startu a obnovy je připravený, dosud neprovedený. T048 na cizí Wi-Fi a plné T049 se skutečným videem zůstávají otevřené. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Po samostatném pokynu spustit nový T049 test a cíleně ověřit první start a obnovu na nové syntetické dávce; potom T048 na cizí Wi-Fi. Plný T050 neopakovat bez nové pochybnosti o finalizaci. |
...
| Automaticke opakujici se ukoly / ColorsAndNumbers | 1 | active | Dnešní sova 19. 9. publikovaná přes Pages artifact, workflow 35432115685 nad produkčním commitem 009fa2d8. Veřejný app.js vybírá `owl_190926.mp3?v=20260919a`; MP3 HTTP 200, `audio/mp3`, 117 648 B. Text zachovaný přesně. | `projects/automated_recurring_tasks.md` | `handoffs/colors_numbers_owl_pages_artifact_checkpoint_2026_07_27.md`; `handoffs/colors_numbers_private_photo_gallery_proposal_2026_07_13.md` | Nový text až na další pokyn; bez dalšího zásahu. |
