...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | 26. 9. 17:23 server upgrade `6865bcab` nasazen, Cockpit smoke 5/5, Camino HTTPS + recovery capability PASS; archiv 104/41/45 a 214 555 219 B zachovaný. T058 stále true/true, grant=false, Funnel off. IPA build 5 čeká na SideStore import; CoreDevice 12040. `camino/docs/M2_RECOVERY_REPORT.md`. M3/M4/U15 platí. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Import IPA, fyzické porovnání telefonu a až poté odblokování; při rozdílu zachovat obě kopie. Viewer/RT3/RT4. |
