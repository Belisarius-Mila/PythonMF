...
| MMTX | 1 | active | Logan při závěrečném loučení stojí zády k divákovi a mává přímo přátelům. Obraz hotového mostu ukazuje tři samostatné klády hned po jejich usazení, ještě před Benjiho přechodem. Oprava ověřena lokálně. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Dokončit p+n a zarovnat čisté profily pro večerní vývoj. |
