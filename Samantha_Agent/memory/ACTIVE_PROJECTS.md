...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | M1 náhled funguje podle Míly. M2a runtime/worker/Cockpit odkaz lokálně připravené a testované; `camino/docs/M2_RUNTIME_REPORT.md`. Bez nasazení, změn iPhonu nebo sítě. Před ostrým audiem chybí pořadí a mezery audiočástí. M3/M4 a U15 zachované, AI odložená. SideStore data PASS, obnova ke kontrole 1. 10. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | M2b: přenos pořadí a mezer audiočástí; potom registrovaný provoz a schválené nasazení. |
