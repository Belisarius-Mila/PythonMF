...
| Znalostni databaze / Knihovna clanku / Knowledge inbox | 2 | active | 2026-09-12: automatické fotografie do 1 MiB na pozadí, více snímků, opakování bez duplicit a správná pole podle kategorie. Funkční commit `832c3360` je pushnutý a nasazený; plná brána 1607 testů, browser, smoke 5/5 i živá Knihovna OK. | `projects/vedecke_clanky.md`; `technical/large_context_intake.md`; `tvbcp/knihovna_cockpit.txt` | `handoffs/knowledge_library_article_editing_2026_07_16.md` | Obnovit Cockpit a ověřit běžnou fotografii na iPhonu |
