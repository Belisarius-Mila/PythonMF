...
| MMTX | 1 | active | Navigace 1–5 opravená: dveře vpřed po dokončení, šipka zpět o jednu scénu; návrat 4/5 funguje i před spuštěním audia. 63 testů a 18 desktopových/mobilních prokliků prošlo. Publikace změny čeká na plnou bránu a Pages. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Dokončit schválené c+p+n a veřejně ověřit opravenou navigaci. |
