...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b 2026-09-19 17:33 CEST: T043/T047 PASS synteticky, T049 prošel syntetickou mobilní částí a je bezpečně ukončené. T050 má připravený oddělený neaktivní běh s 14s zadržením serverového ověření; fyzicky NEPROVEDENO. Plný T049 s novým skutečným videem a T048 na cizí Wi-Fi zůstávají otevřené. Cílená sada 32/32, plná brána 1719/1719 PASS; Funnel vypnutý. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Po samostatném potvrzení spustit T050, předat URL/token a ověřit 100 % + `Ověřuji` bez serverové účtenky; T048 až při cizí Wi-Fi. |
