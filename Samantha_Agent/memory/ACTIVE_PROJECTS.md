...
| MMTX | 1 | active | Checkpoint 2026-08-13 18:16 CEST. Hotovo: Čtyři výslechy mají připravené vlastní obrazové scény s příslušným zvířátkem v popředí; Předchozí stav main byl před tímto checkpointem serverově nasazený a ověřený. Otevřeno: Pozdější nasazení nového checkpointu zatím není tímto snapshotem doložené. Rizika: Žádné další doložené provozní riziko. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Zapojit obrazy do jednotlivých fází dialogu a připravit třetí výslech Sunnyho |
