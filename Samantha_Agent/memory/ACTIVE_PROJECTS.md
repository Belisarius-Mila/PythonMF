...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | M1 náhled potvrzen; M2a runtime/odkaz a M2b pořadí/mezer audia lokálně hotové. `camino/docs/M2b_AUDIO_LAYOUT_REPORT.md`: Swift 36/36, unsigned iOS build a serverové testy PASS. Bez instalace/nasazení/sítě; fyzický průchod otevřený. Před upgradem DB kopie, nejdřív server a pak telefon. M3/M4, U15 zachované, AI odložená; SideStore obnova ke kontrole 1. 10. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | M2c: registrované provozní ovládání a vědomé povolení Vieweru; potom schválené nasazení a aktualizace telefonu. |
