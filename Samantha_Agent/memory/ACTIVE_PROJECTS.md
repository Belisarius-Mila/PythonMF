...
| Cockpit hlavni architektura / modernizace | 1 | active | U01 lokálně dokončený: viditelné výsledky akcí, bez automatického mizení; 4 syntetické browser scénáře, 15 testů a statická brána. Audit v2.1, dosud bez nového nasazení. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | U02 hlavička/návraty, potom U03 kompaktní Dokumenty. Push/nasazení a fyzická přejímka U01 samostatně. |
