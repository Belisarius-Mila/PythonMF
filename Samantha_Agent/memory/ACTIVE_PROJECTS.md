...
| Cockpit hlavni architektura / modernizace | 1 | active | Cockpit Dieta D0-D3 je dokončená a nasazená. UX2 pravdivé navigace je implementované a otestované, ale zatím nenasazené: E-maily mají vlastní rozcestník pro zpracování a archiv, ScanDocu je uvnitř Dokumentů a tyto pracovní schopnosti už nejsou v katalogu Webových aplikací. Všechny původní URL a backendové operace zůstaly zachované. `app/cockpit.py` má při měření 30. 7. 2026 10 027 fyzických a 9 354 neprázdných řádků. | `../AuditCockpit56.txt`; `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md` | `handoffs/cockpit_architecture_current_2026_07_10.md`; `handoffs/cockpit_email_archive_browser_2026_07_09.md` | Po samostatném potvrzení nasadit UX2, spustit smoke test a ručně ověřit tři cesty: E-maily -> Zpracování, E-maily -> Archiv a Dokumenty -> ScanDocu. |
...
| iCloud Mail read-only / Email Cases | 1 | active | Read-only e-mailové workflow, Work Queue a vyladěný Archiv e-mailu jsou nasazené. UX2 pravdivé navigace je implementované a otestované, ale zatím nenasazené: horní E-maily vedou na rozcestník Zpracování / Archiv a obě pracovní části zmizely z katalogu Webových aplikací. URL, payloady a bezpečnostní hranice se nemění. | `projects/email_readonly_oauth.md` | `handoffs/cockpit_email_archive_browser_2026_07_09.md` | Po samostatném potvrzení nasadit UX2 a ručně ověřit obě volby v novém e-mailovém rozcestníku. Zápisy, mazání a odesílání zůstávají mimo rozsah. |
