...
| Cockpit hlavni architektura / modernizace | 1 | active | AuditCockpit56_2 v1.6: rychlejší spouštění stejného Gitu na Macu, bez škrtání testů. Stejných 1655/1655 testů prošlo před i po; unittest 453,73 → 340,30 s, úspora 113,43 s (25,0 %). | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | Pět lokálních kroků čeká na společný push/nasazení na samostatný pokyn. Další HTTP/doménový řez ověřovat cíleně, rizikové a release brány zachovat; poté společná přejímka a audit/UI. |
