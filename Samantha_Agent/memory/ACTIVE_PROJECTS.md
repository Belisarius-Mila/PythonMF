...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C01a rozpracované: 25 testů a přímá iOS kompilace OK, telefon připraven. Xcode build blokuje iOS platform support; signing a fyzická přejímka čekají. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | V Xcode → Settings → Components ověřit a zpřístupnit Platform Support iOS 26.2, potom zopakovat build připraveného CaminoAudio projektu. |
