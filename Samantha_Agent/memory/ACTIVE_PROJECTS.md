...
| MMTX | 1 | active | Checkpoint 2026-09-02 21:04 CEST. Hotovo: Scéna 5 je dokončená Fioniným přechodem, Brunovou pomocí Bunnymu a Loganovou záchranou lampy; scéna 4 na ni přímo navazuje. Otevřeno: Vývojový krok zatím nebyl pushnutý ani nasazený; ruční vizuální a zvukový smoke zůstává otevřený. Riziko: Browserový backend v relaci nebyl dostupný. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Po samostatném potvrzení provést MMTX `p+n` a následný smoke na Macu a iPhonu. |
