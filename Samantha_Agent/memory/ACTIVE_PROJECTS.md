...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C03a 2026-09-19 23:25 CEST: čistý datový kontrakt identit, revizí, času a soukromí U15; 9 syntetických testů a plná brána 1728/1728 PASS. iPhone/server/Viewer integrace a fyzické testy C03a/T096 zůstávají otevřené. C02b T043/T047/T050 prošly synteticky; build 4 má fyzický PASS části A a částečnou část B, T049 potvrzeně zastavené se zachovaným důkazem a vypnutým Funnelem. T048 na cizí Wi-Fi a plné T049 se skutečným videem zůstávají otevřené. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | C03b verzované API a persistence/konflikty; T048 odděleně při dostupné cizí Wi-Fi na potvrzeném soukromém receiveru. Plné T049 až v integrované aplikaci. |
