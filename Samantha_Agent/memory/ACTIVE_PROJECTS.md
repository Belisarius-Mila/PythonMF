...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | Nasazovací příprava hotová: 41 Momentů/45 médií zachované, 3 snapshoty, pevný release a trvalé prostředí. P+n `c9fbc3ee`: 1809 testů a Cockpit smoke 5/5. Camino neinstalované/nespuštěné, bez reader grantu; T058 blokuje zápis/export. `camino/docs/M2c_SERVICE_REPORT.md`; konečný docs p+n doloží živá účtenka. M3/M4 a U15 platí; podpis kontrola 1. 10. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Přesná globální brzda pro LaunchAgent/Serve; bezpečné dokončení obnovy s telefonem, potom Viewer/RT3/RT4. |
