...
| Automaticke opakujici se ukoly / ColorsAndNumbers | 1 | active | Denni soví TTS bezi z `config/OwlSpeech.csv`. Dne 2026-07-27 bylo na Miluv pokyn znovu vygenerovano dnesni MP3 a workflow bylo zmeneno tak, aby uz necommitovalo ani nepushovalo generovane soubory do vyvojoveho `main`; misto toho pripravuje verejny `docs` artifact pro GitHub Pages. Cilenych 22 testu proslo. Nova cesta jeste neni zivou autoritou, protoze Pages stale pouzivaji legacy `main/docs`. Soukrome fotografie nadale nesmi do repozitare ani Pages. | `projects/automated_recurring_tasks.md` | `handoffs/colors_numbers_owl_pages_artifact_checkpoint_2026_07_27.md`; `handoffs/colors_numbers_private_photo_gallery_proposal_2026_07_13.md` | Samostatne potvrzene prepnout GitHub Pages na GitHub Actions, spustit workflow rucne a overit dnesni audio i to, ze `main` po behu zustal na stejnem commitu. |
