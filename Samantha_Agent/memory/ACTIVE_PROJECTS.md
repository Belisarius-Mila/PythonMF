...
| R2-Adam / Janička | 2 | active | R2-Adam má vlastní trvalý chat, soukromý kontext, TXT prostor, dokumentovou lištu a čtečku. Umí bezpečně pracovat s úplnou potvrzenou sadou dokumentů a vytvářet nový create-only TXT bez změny zdrojů. Aktuální `main` je nasazený. | `projects/janicka_r2_adam.md` | `handoffs/workstreams/project-r2-adam-janicka.md`; `tvbcp/workstreams/project-r2-adam-janicka.md` | Ověřit jeden úplný tok e-mail -> private vault -> R2 TXT; potom provést provozní přejímku z pohledu Jany. |
