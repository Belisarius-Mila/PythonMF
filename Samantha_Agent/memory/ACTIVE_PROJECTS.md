...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C04b 2026-09-20: integrovaná offline aplikace má foto/video, explicitní média a komentář k Momentu, obnovu rozpracovaných souborů a ochranu soukromí. Swift 13/13, UI simulátoru a nepodepsaný iOS build PASS. Podpis/instalace blokovány chybějícím profilem nového bundle ID; fyzické T007–T014/T060 neprovedeny. C03b je referenční API bez provozního napojení. C02b T043/T047/T050 prošly synteticky; T048 a plné T049 zůstávají otevřené, T049 receiver zastavený a Funnel vypnutý podle posledního potvrzeného stopu. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Zajistit profil nového Camino ID, instalovat do iPhonu a fyzicky testovat. C04d detail/revize a C05a produkční server následně. T048 odděleně na cizí Wi-Fi. |
