...
| Cockpit hlavni architektura / modernizace | 1 | active | AuditCockpit56_2 aktualizovaný na v1.1; hotové fáze odlišené od dalšího plánu. Lokálně oddělený dokumentový frontend se zachováním chování, 29 cílených testů, plná brána 1641/1641 a shoda browseru před/po. Obnova screenu je nasazená a Mílou potvrzená. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | Samostatně schválit push/nasazení lokálně ověřeného dokumentového modulu. |
