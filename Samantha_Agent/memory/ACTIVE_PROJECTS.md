...
| iCloud Mail read-only / Email Cases | 1 | active | Read-only e-mailové workflow a Work Queue jsou funkční. UX0+UX1 Archivu e-mailu i následné ladění jsou nasazené: schránkový přehled řadí podle skutečného data přijetí, bezpečně vybírá úplnější textovou alternativu z původního EML a otevírá celý originální PDF soubor místo mobilně problematického iframe. Plná brána 1245/1245, řízené nasazení, smoke 5/5 a živý test 117 archivních záznamů prošly. | `projects/email_readonly_oauth.md` | `handoffs/cockpit_email_archive_browser_2026_07_09.md` | Na iPhonu ručně potvrdit nové pořadí zpráv a otevření všech stran vícestránkového PDF. Zápisy, mazání a odesílání zůstávají mimo rozsah. |
