...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C04d a C05b jsou fyzicky přijaté v dostupném rozsahu; C05a loopback smoke je PASS. C05c je lokálně implementované se čtyřmi nezávislými osami Telefon/Mac/Další záloha/AI; T054/T055 mají pouze syntetický důkaz. Swift 33/33, UI T054 1/1, UI pause 1/1, generic iOS build a plná brána 1770/1770 PASS. Push, instalace a fyzická akceptace C05c neproběhly. C05b server je zastavený, token odvolaný a Funnel vypnutý; captive portal T048 zůstává NEOVĚŘENO. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Samostatně povolit push a podepsanou aktualizaci C05c, potom projít `C05c_IPHONE_TEST_PLAN.md`; C06a/C06b/C07 vyžadují vlastní rozhodnutí. |
