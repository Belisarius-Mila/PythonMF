...
| Cockpit hlavni architektura / modernizace | 1 | active | Cockpit Dieta D0-D3 a pravdivá navigace jsou nasazené. Přímé Tailscale doručení důležitých připomenutí i Quick Notes funguje, lokální VocabularyFR/VocabularyIT se spouštějí s použitelným Tk runtime a MultiLO je přidané do katalogu aplikací. Nový celkový audit 5.6 Sol hodnotí bezpečnostní základ jako silný a doporučuje nejdřív zlepšit rozhodovací přehlednost, potom po malých doménách dělit frontend a HTTP routing. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | Po nasazení autosave WIP udělat krátkou ruční Mac/iPhone přejímku a připravit read-only návrh Decision Cockpit D4 s nejvýše třemi aktuálními kroky. |
