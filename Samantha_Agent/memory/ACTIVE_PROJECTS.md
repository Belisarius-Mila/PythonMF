...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b 2026-09-19 22:11 CEST: T043/T047/T050 PASS v syntetickém fyzickém rozsahu; starší T049 prošel syntetickou mobilní částí. Podepsaný build 0.4.0 (4) je na iPhonu. Nová cílená část A PASS: grant a návrat aplikace ponechaly 0/13 a server 0 relací. Část B prokázala vědomý start, přerušení a automatické dokončení stejné relace po otevření s dostupnou sítí; offline otevření po force quit neproběhlo, proto celý plán B není PASS. Nový T049 běh je potvrzeně ukončený, původní Serve přesně obnovený, Funnel vypnutý a důkaz zachovaný. Kód se při testu neměnil; T050 se neopakovalo. T048 na cizí Wi-Fi a plné T049 se skutečným videem zůstávají otevřené. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | T048 při dostupné cizí Wi-Fi po samostatném potvrzení nového receiveru; jedna syntetická dávka a pravdivé čekání/obnova s jediným ověřeným objektem a účtenkou. Plné T049 až v integrované aplikaci. |
