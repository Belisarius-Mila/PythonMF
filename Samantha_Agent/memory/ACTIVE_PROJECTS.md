...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C01b přijato. Potvrzený actor-isolation pád C01c buildu 3 opravuje nainstalovaný build 0.3.0 (4); automatické testy, podpis a zachování 136 položek PASS. C01c ještě není fyzicky přijaté. Viewer základ auditován, runtime/G8 neexistují. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Krátký fyzický Start/Stop na buildu 4, potom T022/T023 nebo další oprava. U15 implementovat až v C03/C04, Viewer v C08c–C08f. |
