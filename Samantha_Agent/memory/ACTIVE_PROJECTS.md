...
| Cockpit hlavni architektura / modernizace | 1 | active | AuditCockpit56_2 v1.2: první dokumentový modul nasazen; druhý modul hledání lokálně oddělen se zachováním chování. 49 cílených Python testů, 8 nových Node kontraktů a shoda browseru 1440/390 px. App zkrácen o dalších 133 řádků. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | Samostatně schválit push/nasazení hledání; další strukturální kandidát jsou stránky čtečky. UI audit následuje po strukturální etapě. |
