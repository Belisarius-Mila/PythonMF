...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | 26. 9. 13:27 služba a privátní HTTPS běží po globální brzdě; stop/start, owner autorizace a Cockpit PASS, Funnel off. Schéma 3, 41 Momentů/45 médií hashově zachované. 1818 testů PASS; nové ovládání lokální bez p+n. Reader grant=false, T058 blokuje zápis/export. `camino/docs/M2c_SERVICE_REPORT.md`. M3/M4 a U15 platí; podpis kontrola 1. 10. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Bezpečné dokončení obnovy s telefonem, potom Viewer/RT3/RT4. |
