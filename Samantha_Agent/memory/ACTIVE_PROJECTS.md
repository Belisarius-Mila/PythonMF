...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | Lokální dokončení T058 pro shodné kopie: server + iPhone tlačítko; rozdíly neslučuje. 9 recovery / 39 Swift / 24 HTTP testů a nepodepsaný build PASS; plná brána viz `camino/docs/M2_RECOVERY_REPORT.md`. Živý audit 26. 9. 13:42: původní HTTPS/Cockpit PASS, Funnel off, T058 stále blokované a nový kód nenasazený. Reader grant=false. M3/M4 a U15 platí; podpis kontrola 1. 10. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Schválené nasazení serveru + téže iPhone appky a krátké porovnání; při rozdílech zachovat data. Potom Viewer/RT3/RT4. |
