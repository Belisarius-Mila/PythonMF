...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C04d a C05b jsou fyzicky přijaté v dostupném rozsahu; C05a loopback smoke je PASS. Podepsané Camino 0.1.0 (3) zachovalo data a C05b prošlo T051, T047-A/B, dostupnou část T048, T049, T050, T052, T053, T058 a pause. Konečný stop: 104 operací, 41 Momentů, 45/45 médií, 214 555 219 B, token odvolán, Serve obnovený a Funnel vypnutý. Plná uzavírací brána 1770/1770 PASS; captive portal T048 zůstává NEOVĚŘENO. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Navázat C05c; C06a/C06b otevřít samostatným rozhodnutím. Captive portal doplnit jen při bezpečně dostupné síti. |
