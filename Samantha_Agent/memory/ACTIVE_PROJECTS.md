...
| MMTX | 1 | active | Checkpoint 2026-08-29 18:13 CEST. Hotovo: Scéna 2 používá 55 pevných anglických a českých stop řízených manifestem a funguje bez systémového hlasu. Otevřeno: Pozdější nasazení nového checkpointu zatím není tímto snapshotem doložené. Rizika: Poslední ověřené nasazení patří jinému commitu než main před tímto checkpointem. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Prakticky projít a poslechnout celou scénu 2 na Linuxu. |
