...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b 2026-09-17 21:01 CEST: T043 PASS v syntetickém rozsahu. Skutečný výpadek zachytil 0/13 serverových částí; po obnově vznikl jediný Asset 13/13, 100 663 553 B, SHA-256 shodný. Harness 0.4.0 (2) opravuje zahozené souběžné impulsy a následná dávka doběhla automaticky; plná brána 1713/1713 PASS. T047–T050 čekají; privátní receiver/Serve cesta po důkazu ještě běží, Funnel je vypnutý. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Po samostatném potvrzení spustit `camino_c02b_t043_stop`, ověřit přesnou obnovu Serve a potom provést T047 se zámkem a force quit. |
