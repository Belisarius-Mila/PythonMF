...
| Cockpit hlavni architektura / modernizace | 1 | active | [PRIPOMENOUT] Stabilizace, status/health, VoiceBridge extrakce, dokumentove read-only sluzby a faze jednotnych modelu/repository jsou historicky hotove a popsane v kanonickem handoffu. Dne 2026-07-26 byla Cockpit dieta znovu potvrzena jako priorita 1. `app/cockpit.py` ma 20 745 fyzickych a 19 620 neprazdnych radku; cely rozsah quality gate ma 57 079 produkcnich a 34 139 testovacich neprazdnych radku. Cilem neni prepis ani plosne mazani, ale male behavior-preserving extrakce se zachovanim endpointu, potvrzovacich bran a private datovych cest. | `../AuditCockpit56.txt`; `reports/cockpit_quality_gate_2026_07_10.md`; `reports/cockpit_persistence_write_map_2026_07_10.md`; `reports/cockpit_dead_legacy_code_inventory_2026_07_10.md`; `reports/cockpit_function_inventory_audit_2026_06_27.md`; `reports/cockpit_post_action_risk_matrix_2026_06_27.md` | `handoffs/cockpit_architecture_current_2026_07_10.md`; `handoffs/cockpit_managed_codex_sessions_2026_07_03.md`; `handoffs/cockpit_session_autosave_cleanup_2026_06_30.md` | Provest pouze read-only Dietu D0: aktualizovat mapu odpovednosti a call-site zavislosti `app/cockpit.py` a vybrat jednu soudrznou e-mailovou skupinu pro naslednou Fazi 1.4. Reindex, legacy cleanup, UI redesign a datove migrace do tohoto kroku nemichat. |
