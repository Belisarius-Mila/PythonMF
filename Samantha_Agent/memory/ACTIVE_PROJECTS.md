...
| Cockpit hlavni architektura / modernizace | 1 | active | U01–U03 lokálně hotové; kompaktní Dokumenty, hledání nahoře, nuly v krátkých řádcích a zdroje v detailu. Audit v2.3; desktop klid 1764→900 px ve fixture, 15 testů a statická brána. Bez nového nasazení. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | U04 stránkování. Push/nasazení a fyzická přejímka samostatně. |
