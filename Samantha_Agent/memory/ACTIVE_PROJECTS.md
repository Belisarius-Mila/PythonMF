...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | [PRIPOMENOUT] Pro dnešek přerušeno; příště T016. Dnešní balíček autorizován k p+n. C01a přijato; C01b implementováno, 47 testů + 2 UI PASS, signed build OK. Verze 0.2.0 nainstalována/spuštěna; krátký funkční test zámku potvrzen Mílou, následuje T016. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Provést T016: 30 minut záznamu převážně pod zámkem, průběžné neosobní zvukové značky, Stop a celý poslech; doplnit délku/velikost z metadat. Potom T018–T021/T024/T059; C01c nezahajovat. |
