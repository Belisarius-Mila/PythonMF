...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b fyzická příprava 2026-09-17 19:58 CEST: samostatný syntetický background URLSession harness 0.4.0 (1) je podepsaný, nainstalovaný a spuštěný na iPhonu. Registrovaný vratný T043 workflow je připravený; plná brána 1709/1709 PASS. Fyzické T043/T047–T050 jsou NEPROVEDENO a Serve cesta/receiver zatím neběží. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Po samostatném potvrzení spustit přesný `camino_c02b_t043_start`, vložit URL a token do harnessu a řízeně přerušit/obnovit síť u T043; Funnel nezapínat. |
