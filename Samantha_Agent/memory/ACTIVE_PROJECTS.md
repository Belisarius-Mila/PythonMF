...
| Cockpit hlavni architektura / modernizace | 1 | active | U01–U05 lokálně hotové; jediná prioritní fronta, běžná práce oddělená od provozních alarmů, statistiky v Servisu. Audit v2.5; 24 cílených testů, 10 browser scénářů a statická brána OK. Bez nového nasazení. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | U06 jednotná navigace, fokus a návraty. Push/nasazení a fyzická přejímka samostatně. |
