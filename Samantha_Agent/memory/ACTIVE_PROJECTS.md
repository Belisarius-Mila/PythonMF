...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C04d je fyzicky přijaté v dostupném lokálním rozsahu a C05a loopback smoke je PASS. C05b trvalá iOS fronta a session-owned privátní obal jsou lokálně hotové; Swift 29/29, workflow 13/13, FastAPI 5/5, UI 1/1 a plná brána 1768/1768 PASS. Push, řízené nasazení, podepsaná aktualizace, Serve a fyzický C05b plán NEPROVEDENO. Funnel zůstává vypnutý. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Checkpoint/push/deploy/install, potom po samostatném potvrzení registrovaného Serve projít `C05b_IPHONE_TEST_PLAN.md`; captive portal jen při dostupné síti. |
