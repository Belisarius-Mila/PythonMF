...
| --- | --- | --- | --- | --- | --- | --- |
| Rodinný kalendář | 1 | active | Samostatný soukromý projekt mimo Knihovnu. Dry-run LaunchAgent je načtený a provozně ověřený. Ostrá runtime větev `enabled` nyní propojuje atomickou persistenci, idempotenci, fail-closed recovery, Keychain a iCloud SMTP adaptér; 218 kalendářových a 1252 úplných testů prošlo. Živá konfigurace zůstává `dry_run`, automatika není aktivní a skutečné tajemství ani SMTP nebyly při vývoji použity. | `projects/family_calendar.md` | `handoffs/workstreams/project-family-calendar.md`; `tvbcp/workstreams/project-family-calendar.md` | Samostatně implementovat potvrzovanou aktivační apply bránu; do nového potvrzení režim neměnit ani nic automaticky neodesílat. |
