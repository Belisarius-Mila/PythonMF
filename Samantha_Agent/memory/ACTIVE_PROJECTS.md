...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b 2026-09-18 08:23 CEST: T043 i T047 PASS v syntetickém rozsahu. T047 má 2 relace, 2 ověřené objekty/účtenky po 100 663 553 B, relaunch po force quit doplnil jen chybějící části. T047 receiver/Serve cesta zůstávají aktivní do samostatně potvrzeného stopu; T048–T050 čekají. Plná brána 1716/1716 PASS. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Po samostatném potvrzení spustit `camino_c02b_t047_stop`, ověřit obnovu Serve a potom provést T048–T050. |
