...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | M1 lokálně implementováno a synteticky ověřeno; `camino/docs/M1_VIEWER_REPORT.md`. Vizuální přejímka otevřená, browser provider nedostupný. Viewer není nasazený; před ostrými dlouhými komentáři chybí pořadí audiočástí v API. Cestovní M2–M4 a U15 zachované, AI odložená. SideStore bez kabelu/data PASS, kontrola obnovy 1. 10. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Otevřít syntetický HTML náhled a přehrát audio/video; potom M2 privátní provoz/Cockpit s opravou pořadí audia. |
