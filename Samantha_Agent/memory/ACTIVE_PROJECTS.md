...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b zahájeno 2026-09-17 16:13 CEST. První lokální checkpoint má obnovitelný receiver 8MiB částí a Swift model pravdivé fronty; cíleně 28/28 a plná brána 1704/1704 PASS. Skutečný URLSession klient, trvalá iOS fronta, instalace a fyzické T043/T047–T050 jsou NEPROVEDENO. Žádná Tailscale/Funnel ani provozní změna neproběhla. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Druhý checkpoint C02b: nativní iOS harness se souborovými URLSession úlohami, trvalou frontou a nejvýše dvěma připravenými částmi; potom fyzické testy přes privátní HTTPS bez veřejného endpointu. |
