...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b 2026-09-19 11:12 CEST: T043 i T047 PASS v syntetickém rozsahu. T047 2 relace/objekty/účtenky zůstávají ověřené; receiver/cesta jsou ukončené, Serve obnovený a Funnel vypnutý. T048/T049 mají oddělené neaktivní workflow. Transfer harness 0.4.0 (3) je podepsaný a nainstalovaný, launch čeká na odemčení; T048–T050 fyzicky NEPROVEDENO. Plná brána 1718/1718 PASS. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Nejprve syntetický T049 na mobilních datech po potvrzeném startu, potom T048 při cizí Wi-Fi. |
