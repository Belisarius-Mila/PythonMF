...
| MMTX | 1 | active | Checkpoint 2026-08-13 23:03 CEST. Hotovo: Opravený Brunův výslech nyní zachovává celou skupinu včetně jasně viditelného Benjiho Otevřeno: Pozdější nasazení nového checkpointu zatím není tímto snapshotem doložené.; Lokální commity čekají na samostatný denní GitHub balíček. Rizika: Poslední ověřené nasazení patří jinému commitu než main před tímto checkpointem. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Použít opravenou verzi při zapojení obrazů do prototypu |
...
| App-server rozhrani / novy Adam | 1 | active | Servisní vývoj 2026-08-13 20:26 CEST. Obnova velkého MMTX vlákna je nasazená. Navazující trvalý převod více `imageGeneration` výstupů do private galerie je implementovaný; čtyři současné obrázky jsou zachráněné a čekají na rozhodnutí. Cílená sada prošla 501/501 a plná brána 1409/1409. Zatím není nasazený. | `tvbcp/architektura_komunikace_samantha.txt`; `technical/project_tvbcp_rules.md`; `technical/global_safety_brake.md`; `technical/capability_routing_rules.md` | `handoffs/human_adam_layer_workstream_start_2026_07_20.md` | Vytvořit checkpoint; potom samostatně potvrdit nasazení a živě ověřit galerii čtyř MMTX obrázků. |
