...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C04d 2026-09-22 je lokálně hotové: deník má detail, datum/filtry, trvalý koncept a revize, vědomé uvolnění Úvahy, zámek, skrytí/obnovu, přesun kapitoly a soukromý navázaný doplněk. Lokální pořadí budoucích operací neznamená serverové přijetí; Důležité zůstává místní do rozšíření C03b. Swift 22/22, UI simulátoru 4/4, nepodepsaný iOS build a plná brána 1740/1740 PASS. C04d ani předchozí hardening nejsou na iPhonu. Starší fyzické C04b výsledky platí; T048 captive portal a plné T060 zůstávají otevřené. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Samostatně potvrdit podpis/instalaci a projít `camino/app/C04d_IPHONE_TEST_PLAN.md`, potom C05a. Hlavní iPhone kvůli T060 uměle nezaplňovat ani nezahřívat. |
