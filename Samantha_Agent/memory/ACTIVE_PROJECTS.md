...
| Cockpit hlavni architektura / modernizace | 1 | active | Screeny a potvrzované uzavření jsou nasazené v Servis → Běžící relace. Chráněný Codex a služby; čerstvá identita před akcí. Plná brána 1554/1554, prohlížečový test i živý smoke 5/5 prošly. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | Používat přehled; před uzavřením screenu s Codexem nejprve ukončit příslušnou relaci. |
