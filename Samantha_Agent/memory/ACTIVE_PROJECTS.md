...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b druhý lokální checkpoint 2026-09-17 16:53 CEST: receiver, trvalý journal a samostatný iOS background URLSession harness pro syntetickou 96MiB dávku jsou připravené. Python 10/10, Swift 18/18, UI 1/1, arm64 build a plná brána 1705/1705 PASS. Podepsání, instalace a fyzické T043/T047–T050 jsou NEPROVEDENO; Tailscale/Funnel ani telefon se neměnily. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Připojit a odemknout iPhone, lokálně podepsat a nainstalovat oddělený harness bez odinstalace Camino Audio; potom první řízený T043 přes privátní HTTPS bez veřejného endpointu. |
...
| Automaticke opakujici se ukoly / ColorsAndNumbers | 1 | active | Dnešní sova 16. 9. publikovaná přes Pages artifact, workflow 35059699238 nad 57c716c7. Veřejný app.js a MP3 HTTP 200 ověřené v 07:31 CEST; text zachovaný přesně. | `projects/automated_recurring_tasks.md` | `handoffs/colors_numbers_owl_pages_artifact_checkpoint_2026_07_27.md`; `handoffs/colors_numbers_private_photo_gallery_proposal_2026_07_13.md` | Nový text až na další pokyn; bez dalšího zásahu. |
