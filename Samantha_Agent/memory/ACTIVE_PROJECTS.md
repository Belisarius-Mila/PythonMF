...
| Cockpit hlavni architektura / modernizace | 1 | active | U01–U06 lokálně hotové; jednotná navigace a 16 dialogů, zachovaný fokus/scroll/drafty při návratu. Audit v2.6; 28 cílených testů a tři browser scénáře. Bez nového nasazení. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | U07 Servis podle účelu. Push/nasazení a fyzická Safari/iPhone přejímka samostatně. |
