...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | Cestovní MVP podle `camino/docs/TRAVEL_MVP_PLAN.md` (25. 9.): jednoduchý HTML Viewer pro Janu, soukromý provoz a základní záloha; AI/širší produkt odložené. C04d/C05b přijaty, C05c stavové UX částečně otevřené. SideStore import bez kabelu a data PASS; profil dle logu do 2. 10. 20:27 CEST, další kontrola 1. 10. Viewer dosud nehotový; ochrana U15 zachována. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | M1 lokální minimalistický Viewer nad syntetickými daty bez AI a nasazení; potom M2–M4 do 2. 10. |
