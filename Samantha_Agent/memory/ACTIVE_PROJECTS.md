...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b fyzická příprava 2026-09-17 20:08 CEST: harness 0.4.0 (1) je podepsaný, nainstalovaný a spuštěný na iPhonu. První potvrzený start receiveru failnul na kolizi názvu `app/email`, bezpečně vrátil trasu a byl opraven na modulový entrypoint; plná brána 1710/1710 PASS. Fyzické T043/T047–T050 jsou NEPROVEDENO a Serve cesta/receiver neběží. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Po novém samostatném potvrzení zopakovat přesný `camino_c02b_t043_start`, vložit URL a token do harnessu a řízeně přerušit/obnovit síť u T043; Funnel nezapínat. |
