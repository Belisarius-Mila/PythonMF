...
| --- | --- | --- | --- | --- | --- | --- |
| Python se Samanthou | 2 | active | První etapa: sedm offline lekcí je oddělených od programu, postup používá trvalá ID a migraci se zachováním originálu. 27 testů i skutečné GUI na Macu prošly; čeká Linux retest. Samostatný terminálový projekt. | `projects/python_se_samanthou.md` | `handoffs/python_se_samanthou_course_package_2026_09_06.md` | Vyzkoušet ZIP z LocalSendu na Linux PC; potom navázat přenosem kurzů a postupu. |
...
| MMTX | 1 | active | Produkční dorovnání 2026-09-02 21:49 CEST. Scéna 5 s Fioniným přechodem, Brunovou pomocí Bunnymu a Loganovou záchranou lampy je publikovaná na GitHub Pages z commitu `d0fd66c`; workflow, deployment i veřejný HTTP 200 jsou korelované. Otevřený zůstává ruční vizuální a zvukový smoke. Riziko: Browserový backend v relaci nebyl dostupný. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Projít celou scénu 5 na Macu a iPhonu, zejména nové hotspoty a audio. |
