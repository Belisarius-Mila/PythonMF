...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C04b 2026-09-21: integrovaná offline aplikace má foto/video, explicitní vazby, obnovu rozpracovaných souborů a ochranu soukromí. T008/T009/T011/T012/T013/T014 fyzicky PASS, T007 částečný a bezpečná část T060 PASS. Lokální low-space/thermal hardening sjednotil politiku textu/fota/audia/videa, přidal řízenou Debug simulaci a ochranu bez mazání; Swift 17/17, UI 3/3, oba nepodepsané iOS buildy a plná brána 1740/1740 PASS. Hardening zatím není nainstalovaný na iPhonu a celý fyzický T060 zůstává částečný bez skutečného nízkého místa. C03b zůstává referenční API bez provozního napojení. T048 má fyzický PASS tří dostupných scénářů; captive portal zůstává NEOVĚŘENO, receiver je zastavený, Serve obnovený a Funnel vypnutý. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Pokračovat C04d a potom C05a. Fyzický low-space T060 jen na postradatelném zařízení nebo při přirozeném stavu; hlavní iPhone nezaplňovat ani nezahřívat. |
