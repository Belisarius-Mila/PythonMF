...
| iCloud Mail read-only / Email Cases | 1 | active | Read-only e-mailové workflow a Work Queue jsou funkční. UX0+UX1 Archivu e-mailu je nasazené jako přehled ve stylu schránky: seznam zpráv, hledání, filtr příloh, lidský detail s bezpečně omezeným textem a sjednocené odkazy na dostupné přílohy. Plná brána, řízené nasazení, povinný smoke 5/5 i živý strukturální test stránky/seznamu/detailu prošly. | `projects/email_readonly_oauth.md` | `handoffs/cockpit_email_archive_browser_2026_07_09.md` | Ručně ověřit desktop a iPhone: seznam, detail, návrat, hledání a otevření známé PDF přílohy. Zápisy, mazání a odesílání zůstávají mimo rozsah. |
