...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | [PRIPOMENOUT] V0.5 + U15 jsou autoritativní: celý `Do deníku` může do soukromého Vieweru Jany, samostatná Úvaha začíná `Jen pro mě`. T016/T018–T021 PASS v dosavadním rozsahu; Viewer základ auditován, ale runtime/G8 neexistují. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Provést T024, potom T059; C01c nezahajovat před uzavřením C01b. U15 implementovat až v C03/C04, Viewer v C08c–C08f. |
