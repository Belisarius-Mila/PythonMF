...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C04b 2026-09-21: integrovaná offline aplikace má foto/video, explicitní média a komentář k Momentu, obnovu rozpracovaných souborů a ochranu soukromí. Nové Camino 0.1.0 (1) je na iPhonu; T008/T009/T011/T012/T013/T014 fyzicky PASS, T007 částečný a bezpečná část T060 PASS. T009 potvrdil pravdivé odmítnutí kamery bez blokace Komentáře a deníku. T014 ověřil zámek, odchod z aplikace i přijatý hovor: přehratelné pravdivě částečné klipy, bez samovolného pokračování a bez hovoru v záznamu. T060 při běžném místě dokončil a přehrál video bez falešného varování nebo výmazu; skutečné nízké místo zůstává neověřené. C03b zůstává referenční API bez provozního napojení. Celý dokončený balíček prošel branou 1740/1740, je pushnutý a řízeně nasazený; zdrojový main, GitHub, Human–Adam a Knihovna jsou čisté a zarovnané. T048 má fyzický PASS běžné cizí Wi-Fi, přerušení/návratu sítě a nedostupného/obnoveného tailnetu; captive portal zůstává NEOVĚŘENO. T048 receiver je zastavený, Serve obnovený a Funnel vypnutý. Plné T049 zůstává otevřené. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Po schválení doplnit malý C04b hardening: injektovatelné nízké místo, automatické prahové testy a samostatně tepelnou politiku; hlavní iPhone nezaplňovat ani nezahřívat. Potom C04d a C05a. |
...
| MMTX | 1 | active | Navigace 1–5 opravená: dveře vpřed po dokončení, šipka zpět o jednu scénu; návrat 4/5 funguje i před spuštěním audia. 63 testů a 18 desktopových/mobilních prokliků prošlo. Veřejně nasazeno: commit 0e1906b8, Pages 34768695626, shoda souborů 10/10 a dalších 18 produkčních prokliků. | `projects/mmtx_story_hotspot_app.md`; `projects/matysek_english_game_concept.md`; `technical/matysek_f5tts_voice_workflow.md` | `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md`; `handoffs/mmtx_scene03_journey_to_lake_publish_2026_07_01.md` | Běžně používat opravenou navigaci, případnou starou kartu obnovit. |
| Samantha external backup | 1 | active | Recovery snapshot `20260914_231439` úspěšný: 63 295 souborů, 0 přeskočeno; manifest, SHA-256 dokumentů Camina a zkušební obnova AGENTS.md ověřeny. | `projects/samantha_external_backup.md` | `handoffs/external_backup_disk_usb_not_detected_2026_07_14.md` (historický) | Další pravidelná recovery záloha podle živého `backup_status.py`; zdrojový snapshot předchází navazujícímu dokumentačnímu commitu. |
...
| Znalostni databaze / Knihovna clanku / Knowledge inbox | 2 | active | 2026-09-12: nové fotografie celkem do 305 KiB včetně náhledu; funkční commit `2f5cf1f9` pushnutý a nasazený, 1622 testů a smoke 5/5 OK. Potvrzený převod 22 starých obrázků dokončen a ověřen: 59,117 → 5,962 MiB, ostatní soubory zachované. Jednorázová záloha 59,35 MiB smazaná na výslovný pokyn; aktivní archiv zachovaný. | `projects/vedecke_clanky.md`; `technical/large_context_intake.md`; `tvbcp/knihovna_cockpit.txt` | `handoffs/knowledge_library_article_editing_2026_07_16.md` | Převod i smazání zálohy uzavřené; běžné používání Knihovny |
...
| Cockpit hlavni architektura / modernizace | 1 | active | U01–U06 dokončené; v meziúkolu 14. 9. vrácené Webové aplikace přímo do horní lišty a ToBeToHave přepnuté na web. 22 cílených testů OK; finální nasazení ověřovat živým auditem. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | [PRIPOMENOUT] U07 až příště: Servis podle účelu. Po uzavření schváleného balíčku fyzická Safari/iPhone přejímka. |
| App-server rozhrani / novy Adam | 1 | active | Oprava 2026-09-02: dlouhé Human–Adam vlákno s obrazovými výstupy se po návratu bezpečně obnoví i při rámci nad 32 MiB; privátní Unix transport má nový konečný limit 64 MiB. Zdrojový main, GitHub i profilové workspaces jsou čisté a zarovnané; nasazení a živý reconnect jsou součástí stejného servisního kroku a musí být doloženy v kanonickém handoffu/TVBCP. | `tvbcp/architektura_komunikace_samantha.txt`; `technical/project_tvbcp_rules.md`; `technical/global_safety_brake.md`; `technical/capability_routing_rules.md`; `LESSONS_LEARNED.md` | `handoffs/human_adam_layer_workstream_start_2026_07_20.md` | Po nasazení ověřit obnovení stejného dlouhého MMTX vlákna, smoke 5/5 a jeden malý read-only tah bez změn. |
...
| Samantha Infrastructure | 1 | active | 2026-09-12: Markdown instrukce a serverové prompty Human–Adam, Knihovny i lazy proudů pushnuté a nasazené. Plná brána OK, smoke 5/5, připojení a čisté kopie ověřeny. | `infrastructure/operating_model.md`; `technical/global_safety_brake.md`; `technical/session_recovery_rules.md`; `technical/project_tvbcp_rules.md`; `tvbcp/workstreams/project-samantha-infrastructure.md` | `handoffs/workstreams/project-samantha-infrastructure.md` | Pokračovat v běžné práci a posoudit praktičnost instrukcí. |
| iPhone Shortcuts / Mobile Input Layer | 2 | paused | Důležitá připomenutí jsou živě ověřená při bdícím i spícím Macu: write-ahead Issue vznikne i ve spánku a po probuzení se právě jednou převezme do Cockpitu. Quick Notes mají lokálně připravenou stejnou dvoucestnou architekturu s odděleným soukromým inboxem, tokenem a správným zdrojem `github_fallback`; aktivní iCloud cesta je odstraněná. Cílená sada 301/301 a plná brána 1506/1506 prošly, secret-free zkratka je validovaná a podepsaná. QN zatím nejsou nakonfigurované, nasazené ani živě otestované. | `technical/iphone_shortcuts_playground.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/iphone_shortcuts_freeze_infrastructure_layer_2026_05_25.md`; `handoffs/workstreams/project-cockpit.md` | Založit soukromý QN inbox a nový token pouze pro něj s `Issues: Read and write`; potom token bez výpisu vložit do ignorovaného `.env` a soukromé zkratky. Nasazení a živé testy potvrdit samostatně. |
...
| Automaticke opakujici se ukoly / ColorsAndNumbers | 1 | active | Od 21. 9. má Sova výchozí promluvu pro každý den bez vlastní CSV položky; přesný den má přednost. Produkční commit `b16cae26`, workflow `35567028291`, veřejný `app.js` vybírá `owl_210926.mp3?v=20260921a`; MP3 HTTP 200, `audio/mp3`, 78 624 B, 13,104 s. Text zachovaný přesně. | `projects/automated_recurring_tasks.md` | `handoffs/colors_numbers_owl_pages_artifact_checkpoint_2026_07_27.md`; `handoffs/colors_numbers_private_photo_gallery_proposal_2026_07_13.md` | Bez zásahu; při novém textu přidat přesný denní řádek, který automaticky přebije `default`. |
...
| Family Memory Films / USA 2019 | 1 | active | Originály USA jsou od 2026-09-15 na externím disku Falta; 2 759 souborů / 33,10 GiB ověřeno SHA-256, původní složka ze synchronizované Plochy odstraněna. Cisty seznam 15 filmu pouzitelnych dnu je odsouhlaseny; `2019-08-05` neni samostatny den filmu, ale smesny zdroj podle item-level review. Master prehled ve stylu `Tomik 2` je ulozen mimo git v `03_overview/usa_2019_tomik2_overview.md`. Predstrihovy formular `03_overview/film_selection_form.html` ma 2688 polozek, denni filtr, rating `A/B/C/skip`, volby pro kratky/dlouhy film, autosave, CSV export a prehravani videi. Adamuv prvni navrh ratingu je aplikovany: `A=406`, `B=913`, `C=1369`. | `projects/family_memory_films.md` | `handoffs/family_memory_usa_2019_tomik2_overview_checkpoint_2026_06_05.md` | Nejprve připojit disk Falta, přesměrovat cestu k originálům USA a ověřit přehrávání. Potom otevrit `http://127.0.0.1:8793/03_overview/film_selection_form.html`, rucne zkontrolovat Adamuv rating, povysit rodinne/emocni momenty podle potreby a stahnout `film_selection_review.csv`; pri navazani brat nejnovejsi `~/Downloads/film_selection_review*.csv` jako zdroj pravdy. Originaly nemazat, neprejmenovavat ani nepresouvat bez potvrzeni. |
...
| ToBeToHave | 2 | active | Schválený prototyp má webovou publikační kopii: 107 otázek, 24 skládání, 184 MP3, 47 WebP. Přímý vstup Webové aplikace obnoven v horní liště Cockpitu. 14 JS + 22 Cockpit testů a 236 HTTP kontrol OK; finální zveřejnění ověřovat živě. | `projects/to_be_to_have.md` | `handoffs/workstreams/project-to-be-to-have.md`; `tvbcp/workstreams/project-to-be-to-have.md` | Webové aplikace → ToBeToHave; po publikování krátká audio přejímka na iPhonu. |
| Linux / instalace a konfigurace | 2 | active | Dorovnáno 2026-08-29 17:05 CEST. Linux zůstává soukromým klientem Samanthy a výukových aplikací; VocabularyEN s předgenerovanými hlasy je zveřejněné. Harryho MP3 jsou věcný milník MMTX, nikoli aktuální stav Linux workstreamu; chybně směrované historické checkpointy jsou v handoffu a TVBCP viditelně korigované. | `projects/linux_workstation.md`; `WORKSTREAMS.md` | zatím nematerializováno; stabilní lazy cesty `handoffs/workstreams/project-linux-workstation.md`; `tvbcp/workstreams/project-linux-workstation.md` | Na Linuxu ručně ověřit VocabularyEN a průchod MMTX; další vývoj vždy zahájit v příslušném pracovním proudu. |
| PictNew / Vocabulary image workflow | 2 | active | Audit 13. 9.: FR Míla 234 / FR Jana 413 / IT Míla 471, bez chybějících obrázků v desktopu i Pythonistě. Osm nových ilustrací, shodné abecední mapování 1 082 vazeb v obou distribucích; Janiny věty 413/413. | `projects/pictnew_vocabulary_image_pipeline.md`; `technical/vocabulary_image_generation_workflow.md` | `handoffs/vocabularyit_mapping_applied_2026_05_20.md` | Při dalších změnách zachovat společný audit tří CSV. V této dávce Míla výslovně delegoval výběr i generování obrázků a c+p bez galerie. |
| Vocabulary FR | 2 | hotovo | Aktualizace 13. 9.: Míla 234 slovíček (+7), Jana 413 kompletních párů vět (+7 doplnění). Nové ilustrace a společný audit bez chybějících souborů; dříve potvrzená aplikace a trénink zachované. | `projects/vocabularyfr_web_trainer.md`; `projects/pictnew_vocabulary_image_pipeline.md`; `tvbcp/workstreams/project-vocabulary-fr.md` | `handoffs/workstreams/project-vocabulary-fr.md` | Načíst aktualizovaná data v aplikaci; vzdálený přenos a iPhone běh místním auditem nepotvrzené. |
| Vocabulary IT | 2 | paused | Aktualizace 13. 9. hotová: 471 slovíček (+8), nové příklady a ilustrace. Původní data i ověřené filtry Last 20/50/HT zachované; společný audit všech tří CSV prošel. | `projects/pictnew_vocabulary_image_pipeline.md`; `tvbcp/workstreams/project-vocabulary-it.md` | `handoffs/workstreams/project-vocabulary-it.md` | Načíst aktualizovaná data v aplikaci; další obsah až podle nového požadavku. |
...
| TTS / české audio nástroje | 1 | active | Aktivní oblast obsahuje obecné vytváření českých MP3 přes `scripts/generate_tts.py` a `scripts/tts_gui.py`, lokální předčítání a obecné předčítání odpovědí v Cockpitu. Starý terminálový komunikační transport, watcher, TTY marker a jeho Cockpit ovládání byly vyřazeny a nejsou součástí TTS toolu. Mikrofon Human–Adam patří projektu Human–Adam. Úklid Apple Music 2026-09-05 odstranil 144 projektových záznamů při zachování audia a vlastních playlistů; ověřené otevírání MP3/M4A/AIFF/WAV nyní používá QuickTime. | `projects/tts_edge_audio_tools.md`; `technical/global_safety_brake.md`; `technical/codex_remote_approval_notice.md`; `technical/codex_permissions_preferences.md` | `handoffs/apple_music_project_audio_cleanup_2026_09_05.md`; `handoffs/autosave_status_and_voice_triage_fix_2026_06_12.md`; `handoffs/adam_voice_bridge_end_to_end_checkpoint_2026_06_05.md`; `handoffs/adam_voice_iphone_autoread_confirmed_2026_06_29.md`; `handoffs/voicebridge_full_access_email_confirmation_closed_2026_06_29.md`; `handoffs/voicebridge_operational_contract_2026_06_30.md` | Pro audio náhledy používat afplay, browser nebo explicitní QuickTime; obecné open nepoužívat. Případný nesoulad na iPhonu ověřit samostatně. |
...
- 2026-08-29 21:01 CEST: Priorita 1, Human–Adam / samoobslužné MMTX `p+n` dokončeno.
  ...
  branou 1478/1478. Regresní živé `p+n` dokončilo commit `0230cf5`, run
  `33269734786`, deployment `6159053676` a HTTP 200; Cockpit smoke je 5/5. Handoff:
