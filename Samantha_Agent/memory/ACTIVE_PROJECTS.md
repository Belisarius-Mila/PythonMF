...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | [PRIPOMENOUT] V0.5 + U15 jsou autoritativní: celý `Do deníku` může do soukromého Vieweru Jany, samostatná Úvaha začíná `Jen pro mě`. T016/T018–T021/T024 PASS; první T059 má ochranu/restart PASS, ale audio pod zámkem FAIL. Viewer základ auditován, runtime/G8 neexistují. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Řízeně zopakovat audio část T059 s Mikrofonem iPhonu; při opakovaném FAIL diagnostikovat C01b. C01c nezahajovat. U15 implementovat až v C03/C04, Viewer v C08c–C08f. |
