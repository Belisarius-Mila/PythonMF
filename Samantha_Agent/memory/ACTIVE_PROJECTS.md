...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | [PRIPOMENOUT] V0.5 + U15 jsou autoritativní: celý `Do deníku` může do soukromého Vieweru Jany, samostatná Úvaha začíná `Jen pro mě`. C01b přijato v prototypovém rozsahu; T059 PASS po řízeném opakování, první tichý úsek zůstává nereprodukovaným rizikem. Viewer základ auditován, runtime/G8 neexistují. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Vyčkat na výslovný pokyn k C01c; T022 na 0.2.0 nespouštět. U15 implementovat až v C03/C04, Viewer v C08c–C08f. |
