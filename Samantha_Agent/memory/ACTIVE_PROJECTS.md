...
| Cockpit hlavni architektura / modernizace | 1 | active | AuditCockpit56_2 v2.0: hluboký UI audit dokončený, 22 nálezů a 11 kroků U01–U11, šest syntetických browser scénářů a dvě route/registry kontroly. Kompaktní řídicí panel je plán, kód aplikace nezměněný. Scroll 10ec0877 potvrzený Mílou. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | Vybrat U01 viditelný výsledek akcí, U02 hlavička/návraty a U03 kompaktní dokumenty; poté stránkování a jednotná hierarchie/styl. |
