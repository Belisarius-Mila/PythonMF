...
| App-server rozhrani / novy Adam | 1 | active | Servisní oprava 2026-08-13 18:51 CEST. Nepřipojitelné MMTX vlákno s generovaným obrázkem překročilo původní 8MiB rámec; připravený 32MiB lokální limit prošel reálným obnovením vlákna i plnou branou 1403/1403. Zatím není nasazený. | `tvbcp/architektura_komunikace_samantha.txt`; `technical/project_tvbcp_rules.md`; `technical/global_safety_brake.md`; `technical/capability_routing_rules.md` | `handoffs/human_adam_layer_workstream_start_2026_07_20.md` | Samostatně potvrdit nasazení a živě ověřit Připojit ve stejném MMTX vlákně. |
