...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C04d je fyzicky přijaté v dostupném lokálním rozsahu. C05a má lokální FastAPI/SQLite/souborový checkpoint s odvolatelnými hashovanými tokeny, obnovitelnými částmi a serverovým ověřením celého Assetu; 23/23 core/regresních, 4/4 FastAPI a plných 1751/1751 testů PASS. Služba, privátní cesty/token, Serve, C05b iPhone klient, push a nasazení NEPROVEDENO. T038, captive portal T048 a plné T060 zůstávají otevřené. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Připravit samostatný loopback smoke C05a nad prázdnými syntetickými daty; potom zvlášť rozhodnout o privátním Serve a C05b. Místní frontu nepovyšovat na serverové přijetí. |
