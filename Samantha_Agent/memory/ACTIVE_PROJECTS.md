...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C04d je hotové, pushnuté a nainstalované jako Camino 0.1.0 (2) na iPhonu 14 Plus / iOS 26.6.1 bez ztráty C04b dat. T010/T019–T021/T026/T030/T039–T041/T096 fyzicky PASS v lokálním rozsahu; T038 zůstává jen synteticky ověřené bez produkční AI. Lokální fronta není serverové přijetí, Důležité zatím nemá C03b operaci a serverové části T040/T096 čekají na C05/C08. T048 captive portal a plné T060 zůstávají otevřené. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Navázat C05a produkčním privátním API; zachovat fail-closed U15 a pravdivě odlišit místní frontu od serverového přijetí. Hlavní iPhone kvůli T060 uměle nezaplňovat ani nezahřívat. |
