...
- **Python se Samanthou** — priorita 2, aktivní; verze 1.2 má dva balíčky po sedmi lekcích a přepínač v GUI. 31 testů a Mac GUI prošly, přídavný balíček funguje i v 1.1. Paměť: `projects/python_se_samanthou.md`; handoff: `handoffs/python_se_samanthou_course_package_2026_09_06.md`. Další krok: retest přepínání a nových lekcí na Linux PC, potom Moje dílna nebo přenos postupu. Záznam je mimo tabulku pracovních proudů; učebna dosud není do Cockpitu zapojená.
