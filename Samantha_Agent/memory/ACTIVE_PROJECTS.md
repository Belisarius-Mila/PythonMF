...
| Cockpit hlavni architektura / modernizace | 1 | active | AuditCockpit56_2 v1.11: oba čtecí HTTP moduly nasazené ve funkčním headu da9d0bea, nový proces a smoke 5/5 ověřeny. Vývojová brána 1675/1675. Společný GitHub balíček schválen včetně zápisu; finální stav ověřit živě. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | Ruční Mac/iPhone přejímka podle reports/cockpit_http_routes_release_2026_09_14.md; poté samostatný audit UI. |
