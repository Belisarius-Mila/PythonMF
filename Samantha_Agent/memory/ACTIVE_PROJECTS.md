...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C04b 2026-09-20: integrovaná offline aplikace má foto/video, explicitní média a komentář k Momentu, obnovu rozpracovaných souborů a ochranu soukromí. Swift 13/13, UI simulátoru, iOS build a plná brána PASS. Nové Camino 0.1.0 (1) je podepsané, nainstalované a spuštěné na iPhonu 14 Plus; u T007 doložen úspěšný zápis a restart, celý T007 částečný; T008/T011/T012 fyzicky PASS; T009/T013–T014/T060 čekají. C03b je referenční API bez provozního napojení. C02b T043/T047/T050 prošly synteticky; T048 a plné T049 zůstávají otevřené, T049 receiver zastavený a Funnel vypnutý podle posledního potvrzeného stopu. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Pokračovat T013–T014, T009 a bezpečnou částí T060; poté C04d detail/revize a C05a server. T048 odděleně na cizí Wi-Fi. |
