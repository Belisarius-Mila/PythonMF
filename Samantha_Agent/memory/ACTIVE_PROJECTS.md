...
| Cockpit hlavni architektura / modernizace | 1 | active | U01–U06 funkčně nasazené, 980aed7a, smoke 5/5; TXT v2.8. Plná brána 1680/1680 OK. Publikační překážka odstraněna; finální balíček/head ověřovat živým auditem. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | [PRIPOMENOUT] U07 až příště: Servis podle účelu. Po uzavření schváleného balíčku fyzická Safari/iPhone přejímka. |
