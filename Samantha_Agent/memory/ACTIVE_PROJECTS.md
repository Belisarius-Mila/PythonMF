...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C00 dokončeno v dostupném rozsahu; Xcode 26.3 a SDK 26.2 ověřeny. C01a nezahájeno, fyzická přejímka NEPROVEDENO. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Po výslovném zadání C01a připojit iPhone a ověřit vývojovou cestu pro audio prototyp. |
