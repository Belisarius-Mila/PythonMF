...
| Znalostni databaze / Knihovna clanku / Knowledge inbox | 2 | active | 2026-09-12: automatické fotografie do 1 MiB na pozadí, více snímků, opakování bez duplicit a správná pole podle kategorie. Browser a plná brána 1607 testů prošly; c+p+n probíhá. | `projects/vedecke_clanky.md`; `technical/large_context_intake.md`; `tvbcp/knihovna_cockpit.txt` | `handoffs/knowledge_library_article_editing_2026_07_16.md` | Dokončit c+p+n, potom ověřit fotografii na iPhonu |
