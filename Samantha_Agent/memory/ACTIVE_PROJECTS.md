...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C02b 2026-09-19 11:45 CEST: T043 a T047 PASS synteticky; T049 prošel v syntetickém mobilním rozsahu: bez grantu i pro novou dávku 0/13, po grantu jediná ověřená relace 13/13, objekt/účtenka 100 663 553 B a shodný hash. T049 je ukončené, Serve obnovený, Funnel vypnutý; plný T049 s novým skutečným videem, T048 a T050 zůstávají otevřené. Plná brána při přípravě 1718/1718 PASS. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | T048 při dostupné cizí Wi-Fi; bez ní lze po zadání připravit T050 se zadrženým ověřením. |
