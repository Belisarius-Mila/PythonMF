...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C01b přijato; C01c 0.3.0 (3) se segmentovým journalem je nainstalované a automaticky ověřené, stará data beze změny. C01c ještě není fyzicky přijaté. Viewer základ auditován, runtime/G8 neexistují. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Provést T022 na 0.3.0, potom T023 nebo opravu. U15 implementovat až v C03/C04, Viewer v C08c–C08f. |
