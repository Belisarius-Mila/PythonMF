...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C01a/C01b/C01c přijaty v prototypovém rozsahu. Build C01c 0.3.0 (4) prošel automatickými testy, podpisem, dvěma pády T022 a poslechovým T023 přes čtyři 55s hranice. Viewer základ auditován, runtime/G8 neexistují. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Po výslovném pokynu C02a. Plný T061 zopakovat v C05a, U15 implementovat v C03/C04 a Viewer v C08c–C08f. |
