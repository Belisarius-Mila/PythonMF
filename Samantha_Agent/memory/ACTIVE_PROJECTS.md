...
| Cockpit hlavni architektura / modernizace | 1 | active | U01/U02 lokálně hotové: viditelná odezva, neořezaná lišta, návraty čteček a náhradní popup odkazy. Audit v2.2, pět browser šířek a 15 testů; dosud bez nového nasazení. | `../AuditCockpit56_2.txt`; `../AuditCockpit56.txt` (historická roadmapa); `reports/cockpit_dieta_d0_2026_07_29.md`; `reports/cockpit_quality_gate_2026_07_10.md`; `tvbcp/workstreams/project-cockpit.md` | `handoffs/workstreams/project-cockpit.md`; `handoffs/cockpit_architecture_current_2026_07_10.md` (historická roadmapa) | U03 kompaktní Dokumenty, potom U04 stránkování. Push/nasazení a fyzická přejímka samostatně. |
