...
| --- | --- | --- | --- | --- | --- | --- |
| Camino | 1 | active | C04d a C05b jsou fyzicky přijaté v dostupném rozsahu; C05a loopback smoke je PASS. C05c zdroj `f0f714f4` je pushnutý a podepsané Camino 0.1.0 (4) nainstalované/spuštěné bez odinstalace. Čtyři nezávislé osy Telefon/Mac/Další záloha/AI prošly Swift 33/33, UI 2/2, generic iOS buildem a plnou bránou 1770/1770; T054/T055 mají jen syntetický důkaz a fyzické C05c čeká. C05b server je zastavený, token odvolaný a Funnel vypnutý; captive portal T048 zůstává NEOVĚŘENO. | `projects/camino.md` | `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` | Dne 2026-09-25 projít `C05c_IPHONE_TEST_PLAN.md`; C06a/C06b/C07 vyžadují vlastní rozhodnutí. |
