...
| Samantha Infrastructure | 1 | active | 2026-09-12: Markdown instrukce zjednodušeny; serverové prompty Human–Adam, Knihovny i lazy proudů sladěny v kódu. Povinný projektový zápis a oprávnění zachovány; aktivace čeká na nasazení. | `infrastructure/operating_model.md`; `technical/global_safety_brake.md`; `technical/session_recovery_rules.md`; `technical/project_tvbcp_rules.md`; `tvbcp/workstreams/project-samantha-infrastructure.md` | `handoffs/workstreams/project-samantha-infrastructure.md` | Samostatně potvrdit nasazení Cockpitu, poté ověřit nové instrukce při obnovení vlákna. |
