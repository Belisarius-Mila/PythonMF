...
- `handoffs/knowledge_library_article_editing_2026_07_16.md` - Knihovna: fotografie na pozadí a správná pole kategorií; 2026-09-12 navazující rozpočet 305 KiB celkem (jeden hlavní JPEG + náhled). Nové ukládání nasazeno (`2f5cf1f9`, 1622 testů, smoke 5/5). Převod 22 starších obrázků připraven bez přepisu a čeká na přesnou větu globální brzdy; důkazy v handoffu a `tvbcp/knihovna_cockpit.txt`.
