...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] Restartový handoff 2026-09-15: po skutečném restartu nejprve read-only přeměřit CloudKit a SSD (předtím 14,75 / 18,81 GiB), ověřit Cockpit; nic nemazat/neinstalovat. USA přesun dokončen, Falta odpojený. C01a BLOCKED na iOS Platform Support, podpisu a fyzické přejímce.
