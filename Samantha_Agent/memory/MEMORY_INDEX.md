...
- `../AuditCockpit56_2.txt` - UI a strukturální audit v2.1: 22 výchozích nálezů, 11 kroků; U01 lokálně implementovaný a ověřený, bez nasazení. Další U02 hlavička/návraty a U03 kompaktní dokumenty. Historický audit zachovaný níže.
...
- `handoffs/workstreams/project-cockpit.md`; `tvbcp/workstreams/project-cockpit.md` - Cockpit 14. 9.: scroll 10ec0877 potvrzený Mílou. Hluboký UI audit v AuditCockpit56_2 v2.1; U01 viditelná odezva dokončený lokálně, další U02.
