...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] Cestovní rozsah v `camino/docs/TRAVEL_MVP_PLAN.md`. M1 lokálně implementováno a synteticky ověřeno, viz `camino/docs/M1_VIEWER_REPORT.md`; další krok otevřít HTML náhled a přehrát audio/video (browser provider není dostupný). M2 soukromý provoz/Cockpit zatím nespouštěn; před ostrými dlouhými komentáři doplnit chybějící pořadí audiočástí v API. M3 záloha/M4 přejímka zůstávají, AI odložena, U15 zachováno. C04d/C05b přijaty, zbytek C05c spojit s M2/M4. SideStore import bez kabelu a data PASS; profil dle logu do 2. 10. 20:27 CEST, kontrola 1. 10., neověřený Refresh All nepoužívat. G8/T060 a captive portal nejsou PASS. Vypnutý C05b/Serve a odvolaný token jsou snapshot z 24. 9., ne dnešní audit.
