...
- `projects/mmtx_story_hotspot_app.md`; `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md` - kanonický stav MMTX: produkční webová scéna 3 pokračuje do Harryho scény 4; historický samostatný prototyp už není aktuální. Otevřený Linux krok je nahradit české a další nepokryté systémové čtení Harryho scény pevnými MP3.
