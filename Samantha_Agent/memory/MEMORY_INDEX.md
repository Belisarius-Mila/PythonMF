...
- `projects/family_memory_films.md` - obecna platforma pro trideni rodinnych fotek/videi a pripravu vzpominkovych filmu; prvni dataset je USA 2019 na plose Macu, cisty seznam 15 dnu je odsouhlaseny, smesny `2019-08-05` se pouziva jen podle item-level review a master prehled `Tomik 2` je ulozen mimo git v `data/private/family_memory_films/usa_2019/03_overview/usa_2019_tomik2_overview.md`.
...
- `handoffs/family_memory_usa_2019_tomik2_overview_checkpoint_2026_06_05.md` - [PRIPOMENOUT] Family Memory Films / USA 2019: master prehled ve stylu `Tomik 2` je hotovy mimo git, obsahuje ciste dny, navrh kratkeho a dlouheho filmu a doporuceni pro fotografie; dalsi krok je predstrihovy formular pro vyber fotek a videi do kratkeho/dlouheho filmu s autosave, CSV exportem a prehravanim videi.
