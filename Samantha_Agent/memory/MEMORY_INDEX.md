...
- `handoffs/workstreams/project-cockpit.md`; `tvbcp/workstreams/project-cockpit.md` - Cockpit: přehled Codexu i screenů a potvrzované uzavření, s ochranou aktuální práce. Lokální testy prošly; plná brána a požadovaný push/nasazení se dokončují.
...
- `projects/mmtx_story_hotspot_app.md`; `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md` - kanonický stav MMTX: scéna 4 pokračuje do dokončené a na GitHub Pages publikované scény 5, kde Fiona přejde, Bruno pomůže Bunnymu a Logan zachrání Brunovu lampu. Otevřený je ruční smoke na Macu a iPhonu.
