...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C01a/C01b/C01c/C02a přijaty v prototypovém rozsahu. C02b T043/T047 PASS synteticky; T049 prošel syntetickou mobilní částí s jednou hashově ověřenou dávkou a nepřeneseným grantem, pak bylo bezpečně ukončené. T050 má připravený neaktivní oddělený běh s 14s zadržením ověření; fyzicky NEPROVEDENO. T048 čeká na cizí Wi-Fi, plné T049 na skutečné nové video. T050 po samostatném potvrzení; plná brána 1719/1719 PASS. Funnel vypnutý, Viewer runtime/G8 chybí a plný T061 zůstává C05a. Profil transfer harnessu do 24. 9. 2026, profil Camino Audio do 22. 9. 18:16 CEST.
