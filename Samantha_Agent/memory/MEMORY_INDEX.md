...
- `handoffs/vocabulary_en_49_images_review_2026_09_06.md` - [PRIPOMENOUT] hotová kandidátní sada 49 ilustrací k dialogům MMTX; review.html s překlady a větami čeká na Mílovu kontrolu. Pict, mapping ani Pages zatím nejsou tímto krokem změněné.
- `reports/vocabulary_en_mmtx_audit_2026_09_05.md` - rozšířený audit slovníčků i dialogů MMTX: 120 doplněných hesel s CZ, Sentence, SentenceT a Benji; celkem 425 karet, 239 Benji a 845 MP3. U 49 novinek zůstává obecná ilustrace; publikace tohoto doplnění čeká na push a Pages.
