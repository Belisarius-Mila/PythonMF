...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C01a/C01b/C01c/C02a přijaty v prototypovém rozsahu. C02b T043 i T047 PASS jen synteticky; T047 dva ověřené objekty/účtenky zůstávají zachované, receiver/cesta jsou vypnuté, Serve obnovený a Funnel vypnutý. T048/T049 mají připravené oddělené neaktivní workflow. Harness 0.4.0 (3) je podepsaný a nainstalovaný, launch čeká na odemčení telefonu; nejprve syntetický T049 na mobilních datech, pak T048 při cizí Wi-Fi. T048–T050 fyzicky NEPROVEDENO, plný T049 čeká na skutečné nové video. Plná brána 1718/1718 PASS. Viewer runtime/G8 chybí a plný T061 zůstává C05a. Profil transfer harnessu do 24. 9. 2026, profil Camino Audio do 22. 9. 18:16 CEST.
