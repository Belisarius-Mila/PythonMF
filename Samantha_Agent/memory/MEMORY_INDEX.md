...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C01a/C01b/C01c/C02a přijaty v prototypovém rozsahu. C02b T043/T047 PASS synteticky; T049 prošel v syntetickém mobilním rozsahu: bez grantu a u nové dávky 0/13, po grantu jediná ověřená relace/objekt/účtenka 13/13, 100 663 553 B, shodný hash. T049 receiver/cesta jsou po stopu vypnuté, Serve obnovený a Funnel vypnutý; důkaz zachovaný. Plný T049 čeká na skutečné nové video; T048 čeká na cizí Wi-Fi a T050 na samostatný test. Plná brána při přípravě 1718/1718 PASS. Viewer runtime/G8 chybí a plný T061 zůstává C05a. Profil transfer harnessu do 24. 9. 2026, profil Camino Audio do 22. 9. 18:16 CEST.
