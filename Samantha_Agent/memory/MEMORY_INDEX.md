...
- `projects/mmtx_story_hotspot_app.md`; `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md` - MMTX 2026-09-12: Logan v závěru otočený k přátelům, tři klády viditelné ihned po sestavení mostu. Oprava ověřena lokálně, p+n pokračuje v témže tahu; obrazový report `reports/mmtx_scene05_artfix_2026_09_12.md`.
