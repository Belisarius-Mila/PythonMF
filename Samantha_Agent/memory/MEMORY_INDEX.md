...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C01a/C01b/C01c/C02a přijaty v prototypovém rozsahu. C02b T043/T047/T050 PASS synteticky; T049 prošel syntetickou mobilní částí. Build transfer harnessu 0.4.0 (4) je podepsaný a nainstalovaný na iPhonu. Cílený fyzický test: část A PASS, vědomý start a automatické dokončení po relaunchi s dostupnou sítí prokázány, ale otevření bez sítě po force quit chybí, takže celý plán B není PASS. Nový T049 běh byl potvrzeně ukončen, Serve přesně obnovený, Funnel vypnutý, syntetický důkaz zachovaný. T050 se bez nové pochybnosti neopakuje. T048 čeká na cizí Wi-Fi, plné T049 na skutečné nové video; Viewer runtime/G8 a plný T061 v C05a zůstávají. Profil transfer harnessu do 24. 9. 2026, profil Camino Audio do 22. 9. 18:16 CEST.
