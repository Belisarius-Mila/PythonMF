...
- `handoffs/adam_voice_bridge_end_to_end_checkpoint_2026_06_05.md` - [PRIPOMENOUT] Adam Voice Bridge end-to-end: Cockpit hlasovy pokyn se dostal do Codex chatu, automatika umi bridge/pending cleanup, VS Code fallback bez ridicich textu, Enter s pauzou a hlasove cteni vysledku pres Edge TTS MP3 helper `scripts/speak_edge_open.py`; dalsi krok je finalni smoke test bez rucniho Enteru.
