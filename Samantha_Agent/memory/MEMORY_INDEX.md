...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] `camino/docs/M2_RECOVERY_REPORT.md`: lokálně doplněné dokončení T058 pro shodné úplné kopie (owner endpoint + iPhone tlačítko), bez automatického merge. 9 recovery / 39 Swift / 24 HTTP testů a nepodepsaný build PASS; plná brána v reportu. Živý audit 26. 9. 13:42: původní služba/HTTPS a Cockpit funkční, Funnel off, T058 oba flagy=true, nová capability není nasazená. Další: schválené nasazení serveru + stejné podepsané appky a krátké porovnání; při rozdílech zachovat obě kopie. Potom Viewer/RT3/RT4; grant=false. M3/M4 zůstávají, AI odložena, U15 zachováno. SideStore kontrola 1. 10., profil dle logu do 2. 10. 20:27 CEST; Refresh All neověřen. G8/T060/captive portal nejsou PASS.
