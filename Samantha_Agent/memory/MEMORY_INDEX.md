...
- `handoffs/email_work_queue_detail_checkpoint_2026_06_01.md` - [PRIPOMENOUT] Email Work Queue checkpoint: detail e-mailu se po kliknuti nacita read-only v Cockpitu, zobrazi telo a metadata priloh, ma volby ulozit/neukladat/kos a dalsi krok je potvrzene davkove ulozeni e-mailu/priloh bez destruktivniho mazani.
