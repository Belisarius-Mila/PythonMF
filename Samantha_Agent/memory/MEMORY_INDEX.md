...
- `handoffs/email_work_queue_detail_checkpoint_2026_06_01.md` - [PRIPOMENOUT] Email Work Queue checkpoint: detail e-mailu se po kliknuti nacita read-only v Cockpitu, rozpracovane polozky lze vratit tlacitkem `Nacti rozpracovane`, popup je opraveny, explicitni detail ma 25MB limit, detail se cachuje v otevrenem okne a dalsi krok je potvrzene davkove ulozeni e-mailu/priloh bez destruktivniho mazani.
