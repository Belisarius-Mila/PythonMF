...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] 2026-09-15: opravy přehrávání ověřeny (32 testů jádra, nově 2 UI testy simulátoru, podepsaný build OK). Průběh i opakování potvrzeny Mílou na iPhonu. Camino Test pro první odmítnutí mikrofonu připraven/podepsán, dosud nenainstalován; metadata i instalace čekají na obnovení vývojového spojení (odpojit/připojit kabel). C01a ještě nepřijato; C01b nezahájeno, profil do 22. 9. 18:16 CEST.
