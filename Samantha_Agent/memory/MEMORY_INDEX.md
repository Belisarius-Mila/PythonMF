...
- `projects/email_readonly_oauth.md` - e-mailová integrace Samanthy: read-only hledání, triage a archivace; UX0+UX1 i ladění archivu jsou nasazené. UX2 pravdivé navigace je otestované, ale nenasazené: E-maily mají vlastní rozcestník Zpracování / Archiv a nejsou v katalogu Webových aplikací.
...
- `handoffs/cockpit_email_archive_browser_2026_07_09.md` - Cockpit Archiv e-mailu: UX0+UX1 a první ladění jsou nasazené; UX2 pravdivé navigace je implementované, otestované a nenasazené. E-maily mají vlastní rozcestník, ScanDocu je pod Dokumenty a pracovní schopnosti zmizely z katalogu Webových aplikací.
