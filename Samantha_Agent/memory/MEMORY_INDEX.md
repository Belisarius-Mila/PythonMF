...
- `projects/family_memory_films.md` - obecna platforma pro trideni rodinnych fotek/videi a pripravu vzpominkovych filmu; prvni dataset je USA 2019 na plose Macu, read-only intake a review prep jsou hotove, aktualni rucni krok je kontrola smesneho `2019-08-05` pres formular `data/private/family_memory_films/usa_2019/02_review/mixed_2019_08_05/mixed_2019-08-05_form.html`.
