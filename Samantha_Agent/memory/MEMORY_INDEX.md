...
- `projects/email_readonly_oauth.md` - e-mailová integrace Samanthy: read-only hledání, triage a archivace; UX0+UX1 Archivu e-mailu je nasazené jako schránkový seznam s čitelným detailem zprávy a sjednocenými přílohami. Brány a živý strukturální smoke prošly, zbývá ruční desktop/iPhone retest.
...
- `handoffs/cockpit_email_archive_browser_2026_07_09.md` - Cockpit Archiv e-mailu: read-only prohlížeč EmailArchiveVault na `/email-archive/`; UX0+UX1 je nasazený jako schránkový seznam s čitelným detailem, bezpečně omezeným tělem zprávy a sjednocenými přílohami. Zbývá ruční desktop/iPhone retest.
