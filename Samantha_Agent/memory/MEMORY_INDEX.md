...
- `projects/mmtx_story_hotspot_app.md`; `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md` - MMTX 13. 9.: opravená navigace scén 1–5, dveře vpřed a šipky zpět; 63 testů, 18 browserových prokliků. Schválené c+p+n probíhá; veřejné ověření čeká na Pages.
