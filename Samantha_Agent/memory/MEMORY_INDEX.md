...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] 2026-09-15: opravy přehrávání ověřeny (32 testů jádra, nově 2 UI testy simulátoru, podepsaný build OK). Opravená aplikace aktualizována a spuštěna na iPhonu; ruční retest čeká. C01a ještě nepřijato; C01b nezahájeno, profil do 22. 9. 18:16 CEST.
