...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C03a čistý model, C03b lokální owner API v1 bez listeneru; C04a první samostatná iPhone aplikace s offline Trip/Day/Moment, značkou, dnešním přehledem a přijatým C01c audiem. D02 běžný Moment začíná `diary`, U15 Úvaha `owner_only`; Swift 8/8, UI simulátoru 1/1, nepodepsaný iOS build PASS. Bez fyzického ověření nové aplikace, synchronizace, Vieweru a T096. Navazuje C04b foto/video, potom další etapy C04/C05. C01a/C01b/C01c/C02a přijaty v prototypovém rozsahu. C02b T043/T047/T050 PASS synteticky, T049 v syntetické mobilní části; build 0.4.0 (4) je nainstalovaný. Část A fyzicky PASS, část B po relaunchi s dostupnou sítí dokončila přenos, ale otevření bez sítě chybí. T049 potvrzeně ukončené, Serve obnovený, Funnel vypnutý a důkaz zachovaný. T048 čeká na cizí Wi-Fi, plné T049 na skutečné video; Viewer runtime/G8 a T061 v C05a zůstávají. Profil transfer harnessu do 24. 9. 2026, Camino Audio do 22. 9. 18:16 CEST.
