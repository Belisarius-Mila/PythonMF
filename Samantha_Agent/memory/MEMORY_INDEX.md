...
- `handoffs/workstreams/project-vocabulary-fr.md`; `tvbcp/workstreams/project-vocabulary-fr.md` - Vocabulary FR: nová samostatná .app pro Janu připravená ve sdíleném PythonMF, záloha zachovaná. 406 slovíček má věty; trénink 107 sloves / 1 926 vět. Přenesená aplikace ověřená; čeká na Janin retest po iCloudu.
