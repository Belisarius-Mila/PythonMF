...
- `../AuditCockpit56_2.txt` - aktuální architektonická roadmapa Cockpitu, verze 1.3 z 13. 9.: první dokumentový modul nasazen; hledání i generování čteček lokálně oddělené, společný push/nasazení odložený. `../AuditCockpit56.txt` zůstává historickou červencovou roadmapou.
...
- `handoffs/workstreams/project-cockpit.md`; `tvbcp/workstreams/project-cockpit.md` - Cockpit 13. 9.: roadmapa v1.3; po nasazených Dokumentech k vyřešení lokálně oddělené hledání a generování čteček. Hledání 49 cílených testů + browser; čtečky 40 cílených Python testů včetně 11 nových Node kontraktů, šest HTML variant byte-shodných. Společný push/nasazení odložený. Dřívější obnova screenu je nasazená a Mílou potvrzená.
