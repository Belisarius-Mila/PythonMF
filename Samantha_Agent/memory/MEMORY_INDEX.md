...
- `projects/python_se_samanthou.md`; `handoffs/python_se_samanthou_course_package_2026_09_06.md` - učebna Pythonu 1.5: AI přes Codex s přihlášením ChatGPT, bez API fallbacku, vše v dílně. 56 testů, čtyři Mac GUI smoke a živý Codex prošly; ZIP 1.5 v LocalSendu. Linux: instalace/přihlášení Codexu a retest.
