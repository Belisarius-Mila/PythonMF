...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C01a/C01b/C01c/C02a přijaty v prototypovém rozsahu. C02b T043/T047/T050 PASS synteticky; druhý T050 běh souběžně zachytil telefonní `Ověřuji` a serverové `verifying` bez účtenky, potom jediný ověřený objekt. T049 prošel syntetickou mobilní částí s nepřeneseným grantem; jeho i oba T050 běhy jsou bezpečně ukončené, Funnel vypnutý. Automatický start po návratu aplikace je otevřená UX výhrada. T048 čeká na cizí Wi-Fi, plné T049 na skutečné nové video; přípravná brána 1719/1719 PASS. Viewer runtime/G8 chybí a plný T061 zůstává C05a. Profil transfer harnessu do 24. 9. 2026, profil Camino Audio do 22. 9. 18:16 CEST.
