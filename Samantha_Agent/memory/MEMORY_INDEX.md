...
- `projects/automated_recurring_tasks.md`; `handoffs/colors_numbers_owl_pages_artifact_checkpoint_2026_07_27.md` - automatické opakující se úkoly a ColorsAndNumbers soví TTS; dnešní sova 19. 9. publikovaná workflow 35432115685 nad produkčním commitem 009fa2d8, veřejný app.js a MP3 HTTP 200 / `audio/mp3` / 117 648 B ověřené. Pages artifact je živá publikační autorita a workflow nemění `main`.
