...
- `../AuditCockpit56_2.txt` - UI a strukturální audit v2.6: 22 výchozích nálezů, 11 kroků; U01–U06 lokálně implementované a ověřené, bez nasazení. Další U07. Historický audit zachovaný níže.
...
- `handoffs/workstreams/project-cockpit.md`; `tvbcp/workstreams/project-cockpit.md` - Cockpit 14. 9.: scroll 10ec0877 potvrzený Mílou. Hluboký UI audit v AuditCockpit56_2 v2.6; U01–U06 dokončené lokálně, další U07.
