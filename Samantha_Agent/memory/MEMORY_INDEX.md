...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] Cestovní plán `camino/docs/TRAVEL_MVP_PLAN.md`. M1 náhled potvrzen; M2a/M2b a M2c provozní ovládání lokálně hotové, viz `camino/docs/M2c_SERVICE_REPORT.md`. Offline 17/17, server 22/22 PASS; bez nasazení/tokenů/launchd/sítě/telefonu. Nová konfigurace dosud chybí. Další: schválit nasazovací přípravu a konkrétní stávající archiv; snapshot před upgradem SQLite na 3, server před telefonem, krátký RT3/RT4 a reálný restart služby. M3 záloha/M4 přejímka, AI odložena, U15 zachováno. SideStore data PASS, kontrola podpisu 1. 10.; profil dle logu do 2. 10. 20:27 CEST, Refresh All neověřen. G8/T060/captive portal nejsou PASS; provozní snapshot 24. 9. není aktuální audit.
