...
- `../AuditCockpit56_2.txt` - UI a strukturální audit v2.5: 22 výchozích nálezů, 11 kroků; U01–U05 lokálně implementované a ověřené, bez nasazení. Další U06. Historický audit zachovaný níže.
...
- `handoffs/workstreams/project-cockpit.md`; `tvbcp/workstreams/project-cockpit.md` - Cockpit 14. 9.: scroll 10ec0877 potvrzený Mílou. Hluboký UI audit v AuditCockpit56_2 v2.5; U01–U05 dokončené lokálně, další U06.
