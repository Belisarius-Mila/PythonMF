...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C01a/C01b/C01c/C02a přijaty v prototypovém rozsahu. C02b má receiver a samostatný iOS background URLSession harness pro syntetická data; lokální testy/build jsou zelené, ale podpis, instalace a fyzické T043/T047–T050 čekají. Další je připojit iPhone a zahájit T043; Viewer runtime/G8 chybí a plný T061 zůstává C05a. Profil do 22. 9. 18:16 CEST.
