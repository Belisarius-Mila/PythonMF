...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] `camino/docs/M2c_SERVICE_REPORT.md`: nasazovací příprava původního archivu hotová, 41 Momentů/45 médií hashově zachované, 3 snapshoty, pevný release/trvalý Python/owner token soukromě. P+n kódu `c9fbc3ee`: 1809 testů, Cockpit smoke 5/5. Camino není instalované/spuštěné a nemá reader grant; metadata stále 1. Další: přesná globální brzda pro LaunchAgent/Serve, bezpečné dokončení obnovy po T058 (zápis/export stále blokovaný), pak Viewer a RT3/RT4. Konečný docs p+n ověřit živou účtenkou. M3/M4 zůstávají, AI odložena, U15 zachováno. SideStore kontrola 1. 10., profil dle logu do 2. 10. 20:27 CEST; Refresh All neověřen. G8/T060/captive portal nejsou PASS.
