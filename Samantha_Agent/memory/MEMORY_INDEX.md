...
- `projects/mmtx_story_hotspot_app.md`; `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md` - MMTX 2026-09-12: nový závěrečný obraz loučení s Loganem, To the lake! až na něm, dialog nahoře bez názvu scény. Produkce ověřena: commit `84c2809fb334`, Pages `34681649893`, 8/8 veřejných souborů shodných; zbývá běžný poslech na skutečném iPhonu.
