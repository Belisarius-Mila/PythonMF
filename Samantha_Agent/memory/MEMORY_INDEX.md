...
- `handoffs/mobile_document_processing_raw_bw_classification_2026_05_27.md` - [PRIPOMENOUT] dokumentovy vault: mobilni procesor `process_mobile_document_inbox` existuje, default zpracovani je RAW a BW cisteni jen nouzove; klasifikace receptu/jidla/dietnich pokynu i dvoukrokovy finalni import s `case_id` jsou hotove, dalsi krok je realny end-to-end test a zkratka pro import GPT PDF z Downloads.
