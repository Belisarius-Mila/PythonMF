...
- `handoffs/knowledge_library_article_editing_2026_07_16.md` - Knihovna: editace článků a příloh; 2026-09-12 fotografie automaticky do 1 MiB, ukládání karty bez čekání, více snímků se správným cílem a opakování bez duplicit; mimo Knihy skrytá knižní pole. Funkční commit `832c3360` je nasazený, 1607 testů a smoke 5/5 OK; důkazy v handoffu a `tvbcp/knihovna_cockpit.txt`.
