...
- `projects/email_readonly_oauth.md` - e-mailová integrace Samanthy: read-only hledání, triage a archivace; UX0+UX1 pro Archivu e-mailu připravuje schránkový seznam, čitelný detail zprávy a sjednocené přílohy. Implementace prošla plnou bránou, čeká na samostatně potvrzené nasazení a vizuální retest.
...
- `handoffs/cockpit_email_archive_browser_2026_07_09.md` - Cockpit Archiv e-mailu: read-only prohlížeč EmailArchiveVault na `/email-archive/`; UX0+UX1 je implementovaný jako schránkový seznam s čitelným detailem, bezpečně omezeným tělem zprávy a sjednocenými přílohami. Čeká na nasazení a ruční desktop/iPhone retest.
