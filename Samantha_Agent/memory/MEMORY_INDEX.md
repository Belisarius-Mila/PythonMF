...
- `technical/media_review_form_workflow.md` - [PRIPOMENOUT] znovupouzitelny workflow pro lokalni formular nad fotkami/videi: thumbnails, editace CSV, tlacitko `Přehrát video` pres read-only lokalni server, export CSV a pravidlo brat nejnovejsi stazene CSV jako zdroj pravdy.
