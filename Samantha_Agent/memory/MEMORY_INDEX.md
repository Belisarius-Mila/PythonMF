...
- `projects/samantha_external_backup.md` - [PRIPOMENOUT] offline zálohování `PythonMF`/Samanthy na externí disk: poslední úspěšná recovery záloha je 2026-05-29 ve snapshotu `20260529_225518`; stav hlídat přes `scripts/backup_status.py`; při příští recovery záloze vytvořit nový snapshot s opraveným filtrem, ověřit manifest a teprve potom samostatně potvrdit případné smazání nafouknutého snapshotu `20260529_225518`.
- `projects/pozustalost_rodinny_plan_2026_05_30.txt` - [PRIPOMENOUT] priorita 1 rodinný nouzový balíček / pozůstalost: git-safe návrh struktury pro šifrovaný private balík s financemi, majetkem, závazky, pojistkami, nemovitostmi, právními dokumenty, přáními rodičů a postupem pro dcery; konkrétní citlivá data patří jen mimo git do šifrovaného uložiště.
