...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C03a je čistý model a C03b lokální owner API bez listeneru. C04d je pushnuté a nainstalované jako Camino 0.1.0 (2) na iPhonu 14 Plus / iOS 26.6.1 bez ztráty C04b dat. T010/T019–T021/T026/T030/T039–T041/T096 jsou fyzicky PASS v dostupném lokálním rozsahu; T038 zůstává jen synteticky ověřené bez produkční AI. Lokální fronta není serverové přijetí, Důležité zatím nemá C03b operaci a serverové části T040/T096 čekají na C05/C08. C05a navazuje. Plné T060 zůstává částečné a hlavní iPhone nezaplňovat ani nezahřívat. T048 captive portal, Viewer/G8, plné T049 a T061 zůstávají otevřené; T048/T049 receiver je zastavený, Serve obnovený a Funnel vypnutý.
