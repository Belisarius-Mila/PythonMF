...
- `handoffs/email_processing_cockpit_decision_ui_2026_06_01.md` - [PRIPOMENOUT] Email Processing v Cockpitu: 7denni e-mailovy prehled se zobrazuje jako rozhodovaci karty s volbami `Zpracovat`, `Ulozit`, `Ignorovat` a `Kos`; volby se ukladaji soukrome mimo git a skutecne cteni/stahovani/mazani musi zustat potvrzovane.
