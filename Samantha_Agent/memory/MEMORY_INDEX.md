...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] Od 25. 9. platí zúžený `camino/docs/TRAVEL_MVP_PLAN.md`: M1 lokální HTML Viewer pro Janu → M2 soukromý provoz/Cockpit → M3 jednoduchá záloha → M4 krátká přejímka do 2. 10. AI a širší produkt odloženy, U15 zachováno. C04d/C05b přijaty; C05c 0.1.0 (4) má zachování dat PASS, zbývající stavové UX spojit s M2/M4. SideStore import bez kabelu a data PASS; podle logu profil do 2. 10. 20:27 CEST, další kontrola 1. 10. Žádná záruka podpisu do 17. 10.; nepoužívat neověřený Refresh All. Viewer/M3 dosud nehotové, plné G8/T060 a captive portal nejsou PASS. Stav vypnutého C05b/Serve a odvolaného tokenu je snapshot z 24. 9., ne dnešní audit.
