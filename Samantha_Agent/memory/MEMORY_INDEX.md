...
- `handoffs/workstreams/project-vocabulary-fr.md`; `tvbcp/workstreams/project-vocabulary-fr.md` - Vocabulary FR: Trénink sloves má 107 sloves a 1 926 vět. Vzpomínání čeká na napsaný tvar nebo Dál, správný tvar pokračuje automaticky a písmena nabíhají po 0,44 s. Úprava prošla 18 testy a Tk ověřením; zbývá ruční retest a distribuce.
