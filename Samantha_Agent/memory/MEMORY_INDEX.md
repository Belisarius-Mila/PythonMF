...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C01a/C01b/C01c/C02a přijaty v prototypovém rozsahu. C02b T043/T047/T050 PASS synteticky; T049 prošel syntetickou mobilní částí. T049 i oba T050 běhy jsou bezpečně ukončené, Funnel vypnutý. Build transfer harnessu 0.4.0 (4) na Macu brání samovolnému prvnímu startu nové dávky s mobilním grantem; Swift 22/22, simulátorový UI test a nepodepsaný iOS build PASS. Schválené p+n funkčního balíčku: 17 commitů na GitHubu po plné bráně 1719/1719, Cockpit nasazený s novým procesem a smoke 5/5; konečný head ověřit živě. Build 4 je podepsaný a nainstalovaný na iPhonu; cílený fyzický test první mobilní dávky a obnovy je připravený v `camino/tasks/C02b_BUILD4_FIRST_START_FIELD_PLAN.md`, zatím neprovedený. Plný T050 se bez nové pochybnosti o finalizaci neopakuje. T048 čeká na cizí Wi-Fi, plné T049 na skutečné nové video. Viewer runtime/G8 chybí a plný T061 zůstává C05a. Profil dosavadního transfer harnessu do 24. 9. 2026, profil Camino Audio do 22. 9. 18:16 CEST.
