...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] Cestovní plán `camino/docs/TRAVEL_MVP_PLAN.md`. M1 náhled potvrzen; M2a runtime/odkaz a M2b pořadí/mezer audia lokálně hotové, viz `camino/docs/M2b_AUDIO_LAYOUT_REPORT.md`. Swift 36/36, unsigned iOS build, serverové testy PASS; bez instalace/nasazení/sítě. M2c: registrované provozní ovládání a povolení Vieweru. Před SQLite upgradem kopie DB; nasadit nejdřív server, potom telefon a krátký RT3/RT4. M3 záloha/M4 přejímka, AI odložena, U15 zachováno. SideStore původní data PASS, kontrola podpisu 1. 10.; profil dle logu do 2. 10. 20:27 CEST, Refresh All neověřen. G8/T060/captive portal nejsou PASS; provozní snapshot 24. 9. není aktuální audit.
