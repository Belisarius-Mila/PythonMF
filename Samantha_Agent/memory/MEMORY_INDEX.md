...
- `handoffs/workstreams/project-vocabulary-fr.md`; `tvbcp/workstreams/project-vocabulary-fr.md` - kanonický stav Vocabulary FR: nový Trénink sloves má 107 sloves, 1 926 vět, obrázky, řízený poslech a přepínatelné vzpomínání. 31 cílených testů a plná brána prošly; zbývá ruční vizuální/poslechový retest na Macu a Linuxu a distribuční build.
