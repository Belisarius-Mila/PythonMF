...
- `projects/janicka_r2_adam.md` - funkční samostatný R2-Adam pro Janičku: vlastní chat, soukromý kontext, TXT prostor, dokumentová lišta, čtečka a potvrzovaná práce s úplnými sadami read-only zdrojů. E2 živě ověřilo úplný tok e-mail -> vault -> create-only R2 TXT. E3 potvrdilo ruční revizi a backendovou dostupnost PDF; lokální oprava lidského TXT čeká na nasazení a krátký vizuální retest.
