...
- `projects/samantha_external_backup.md` - offline zálohování `PythonMF`/Samanthy na externí disk: poslední úspěšná recovery záloha je 2026-05-29 ve snapshotu `20260529_225518`; stav hlídat přes `scripts/backup_status.py`; `data/session_autosave/` se po velkém nárůstu vynechává i z recovery backupu.
