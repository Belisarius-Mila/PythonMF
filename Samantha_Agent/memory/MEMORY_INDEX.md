...
- `projects/mmtx_story_hotspot_app.md`; `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md` - MMTX 2026-09-12: nový závěrečný obraz loučení s Loganem, To the lake! až na něm, dialog nahoře bez názvu scény. Vývoj ověřen, řízená produkční publikace probíhá v témže tahu.
