...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] `camino/docs/M2c_SERVICE_REPORT.md`: 26. 9. 13:27 Camino LaunchAgent a privátní HTTPS běží po globální brzdě; řízený stop/start a HTTPS autorizace PASS, Cockpit zachovaný, Funnel off. Schéma 3 po snapshotu, 41 Momentů/45 médií hashově zachované. 29 cílených / 1818 plných testů PASS; nové provozní ovládání zatím lokální bez p+n, backend release c9fbc3ee. Reader grant=false, T058 stále blokuje zápis/export. Další: bezpečně dokončit obnovu s telefonem, potom Viewer/RT3/RT4. M3/M4 zůstávají, AI odložena, U15 zachováno. SideStore kontrola 1. 10., profil dle logu do 2. 10. 20:27 CEST; Refresh All neověřen. G8/T060/captive portal nejsou PASS.
