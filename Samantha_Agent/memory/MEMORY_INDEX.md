...
- `projects/email_readonly_oauth.md` - e-mailová integrace Samanthy: read-only hledání, triage a archivace; po nasazeném UX0+UX1 je připravené nenasažené ladění řazení podle přijatého data, úplnějšího bezpečného textu z EML a přímého otevření celého PDF. Plná brána prošla, další krok je potvrzené nasazení a iPhone retest.
...
- `handoffs/cockpit_email_archive_browser_2026_07_09.md` - Cockpit Archiv e-mailu: read-only prohlížeč EmailArchiveVault na `/email-archive/`; UX0+UX1 je nasazený, následné nenasažené ladění opravuje řazení podle přijatého data, úplnější bezpečný text z EML a přímé otevření celého PDF na mobilu.
