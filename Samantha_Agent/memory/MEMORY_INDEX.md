...
- `projects/python_se_samanthou.md`; `handoffs/python_se_samanthou_course_package_2026_09_06.md` - offline učebna Pythonu 1.3: Moje dílna s vlastními pokusy a dva balíčky po sedmi lekcích. 42 testů a tři Mac GUI smoke prošly; jediný ZIP 1.3 v LocalSendu čeká na Linux retest.
