...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C03a čistý model, C03b lokální owner API bez listeneru; C04a offline Trip/Day/Moment a C01c audio, C04b foto/video. T008/T009/T011/T012/T013/T014 fyzicky PASS, T007 částečný a bezpečná část T060 PASS. Lokální low-space/thermal hardening sjednotil politiku textu/fota/audia/videa, přidal pouze Debug simulaci a ochranu bez mazání; Swift 17/17, UI 3/3, oba nepodepsané iOS buildy a plná brána 1740/1740 PASS. Hardening není na iPhonu a plné T060 zůstává částečné bez skutečného nízkého místa; hlavní iPhone nezaplňovat ani nezahřívat. C04d/C05a navazují. C02b T043/T047/T050 PASS synteticky, T049 v syntetické mobilní části; build 4 je nainstalovaný. T048 má PASS tří dostupných scénářů, captive portal NEOVĚŘENO; T048/T049 jsou ukončené, Serve obnovený a Funnel vypnutý. Viewer/G8, plné T049 a T061 v C05a zůstávají otevřené.
