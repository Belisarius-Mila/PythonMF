...
- `projects/python_se_samanthou.md`; `handoffs/python_se_samanthou_course_package_2026_09_06.md` - učebna Pythonu 1.4: AI průvodce s doptáváním a aktivací editoru v dílně. 51 testů, čtyři Mac GUI smoke a živé API prošly; ZIP 1.4 v LocalSendu. Zbývá Linux retest psaní a vlastní API klíč.
