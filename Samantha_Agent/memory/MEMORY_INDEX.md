...
- `projects/camino.md`; `handoffs/workstreams/project-camino.md`; `tvbcp/workstreams/project-camino.md` — [PRIPOMENOUT] V0.5 + U15 jsou autoritativní. C03a je čistý model a C03b lokální owner API bez listeneru. C04d je lokálně hotové: detail deníku, trvalý koncept/revize, vědomé uvolnění Úvahy, zámek, skrytí/obnova, přesun kapitoly a soukromý navázaný doplněk; Swift 22/22, UI 4/4, nepodepsaný iOS build a plná brána 1740/1740 PASS. C04d ani low-space/thermal hardening nejsou na iPhonu; fyzická přejímka má vlastní plán a vyžaduje samostatně potvrzenou instalaci. Lokální fronta není serverové přijetí a Důležité zatím nemá C03b operaci. Starší C04b fyzické výsledky platí, plné T060 zůstává částečné a hlavní iPhone nezaplňovat ani nezahřívat. C05a navazuje. T048 captive portal, Viewer/G8, plné T049 a T061 zůstávají otevřené; T048/T049 receiver je zastavený, Serve obnovený a Funnel vypnutý.
