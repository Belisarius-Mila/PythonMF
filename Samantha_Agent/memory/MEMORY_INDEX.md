...
- `projects/mmtx_story_hotspot_app.md`; `handoffs/workstreams/project-mmtx.md`; `tvbcp/workstreams/project-mmtx.md` - kanonický stav MMTX: scéna 4 pokračuje do dokončené scény 5, kde Fiona přejde, Bruno pomůže Bunnymu a Logan zachrání Brunovu lampu. Vývojový checkpoint čeká na samostatné `p+n` a ruční smoke na Macu a iPhonu.
