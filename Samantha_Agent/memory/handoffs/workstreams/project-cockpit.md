...
Co se resilo:
Schválené vydání dokumentového a archivačního HTTP rozhraní.

Co je hotove:
- Funkční head da9d0bea nasazen, nový proces a smoke 5/5 ověřeny; přesný ruční test připraven.

Co neni hotove:
- Tento zápis předchází GitHub balíčku a finálnímu ověření headu; živý stav ověřit auditem. Mac/iPhone přejímka a pozdější audit UI otevřené.

Dalsi krok:
Dokončit vydání a předat Mílovi test; audit UI později samostatně.
