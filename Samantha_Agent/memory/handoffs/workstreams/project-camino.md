...
- Integrovaná aplikace je podepsaná a nainstalovaná; T008/T011/T012/T013 fyzicky prošly, T007 zůstává částečný a u T014 prošla větev zámku telefonu. Odchod z aplikace a samostatné systémové přerušení T014, T009 a bezpečná část T060 ještě čekají. Nový bundle ID nepřebírá prototypová audio data; místní úložiště není záloha na Macu.

### Další krok
- Dokončit T014: u nového krátkého videa samostatně odejít z aplikace a po návratu ověřit pravdivý úplný nebo částečný stav; potom samostatně vyvolat bezpečné systémové přerušení. Následují T009 a bezpečná část T060, poté C04d a C05a. Captive portal T048 ověřit jen při skutečně dostupné síti; plné T049 čeká na produkční propojení.
...
- C04b pokračuje dokončením dvou zbývajících větví T014, potom T009 a bezpečnou částí T060; C04d přidá detail a vědomou revizi Úvahy.
