...
### Hotovo
- Funkční commit `832c3360` je na GitHubu a nasazený; ověřen nový proces, smoke 5/5, přesná serverová stránka i worker a HTTP převod. Živá Knihovna je připojená, oba profily čisté a zarovnané.
...
### Další krok
- Obnovit Cockpit na iPhonu a vložit jednu běžnou fotografii; před zavřením počkat na stav Připojeno.

### Navrhované další kroky
- Až podle reálné zkušenosti případně upravit kompresi; další mechanismus přenosu zatím nezavádět.

### Technický důkaz
- Nasazení 2026-09-12 21:40 CEST; `verified_current`, code stamp `e1e1b0f2b9e7e865`. Následující commit uchovává pouze tento doklad dokončení.
