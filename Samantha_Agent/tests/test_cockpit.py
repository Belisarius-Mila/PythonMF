...
class CockpitTests(unittest.TestCase):
    ...
    def test_cockpit_dev_runner_run_action_reports_failed_command(self) -> None:
        ...
        self.assertIn("audio_context_fallback", COCKPIT_HTML)
        self.assertIn("audio_speak_skipped_in_progress", COCKPIT_HTML)
        ...
        voice_dashboard_escape = COCKPIT_HTML.index("${escapeHtml(voicePendingMessage || voicePendingShort || voiceState)}")
