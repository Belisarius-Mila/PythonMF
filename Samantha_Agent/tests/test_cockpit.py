...
class CockpitTests(unittest.TestCase):
    ...
    def test_cockpit_html_contains_library_attachment_view(self) -> None:
        ...
        self.assertIn("učebnice", COCKPIT_HTML)
        self.assertIn("cizojazyčná literatura", COCKPIT_HTML)
        ...
        self.assertIn('function addLibraryBookOption(kind, target = "create")', COCKPIT_HTML)
        ...
        close_start = COCKPIT_HTML.index("function closeLibraryModal()")
        close_end = COCKPIT_HTML.index("function setLibraryAddMode(", close_start)
        close_source = COCKPIT_HTML[close_start:close_end]
        self.assertIn('libraryModal.classList.add("hidden")', close_source)
        self.assertNotIn("clearLibraryBookOcrPhotos", close_source)
        self.assertNotIn("closeLibraryEditor", close_source)
        self.assertIn("if (libraryOpened) return;", COCKPIT_HTML)
        ...
        self.assertIn("libraryEditBookNewCategoryInput", COCKPIT_HTML)
        self.assertIn("libraryEditBookAddCategoryBtn", COCKPIT_HTML)
        self.assertIn("libraryEditBookOptionsStatus", COCKPIT_HTML)
        self.assertIn('addLibraryBookOption("category", "edit")', COCKPIT_HTML)
        self.assertIn("const categoryChoices = isEdit ? libraryEditBookCategoryChoices : libraryBookCategoryChoices;", COCKPIT_HTML)
        self.assertIn("if (isEdit) markLibraryEditorDirty();", COCKPIT_HTML)
        self.assertIn("kartu potvrď tlačítkem Uložit úpravy", COCKPIT_HTML)
    ...
    def test_cockpit_html_contains_document_work_controls(self) -> None:
        self.assertNotIn("<h2>Dnes</h2>", COCKPIT_HTML)
        self.assertIn("Stav", COCKPIT_HTML)
        self.assertNotIn("<h2>Rychlé akce</h2>", COCKPIT_HTML)
        ...
        self.assertNotIn("todayNewPdfCount", COCKPIT_HTML)
        ...
        self.assertIn("Provoz: nutná kontrola", COCKPIT_HTML)
        ...
        self.assertIn("scanDocuBtn", COCKPIT_HTML)
        self.assertNotIn("dashboardProcessBtn", COCKPIT_HTML)
        ...
        self.assertIn("urgentReminderAlertBtn", COCKPIT_HTML)
        self.assertNotIn("dashboardUrgentRemindersBtn", COCKPIT_HTML)
        ...
        self.assertIn("decisionCockpitStatus.textContent", COCKPIT_HTML)
        self.assertNotIn("dashboardMorningSentence", COCKPIT_HTML)
        self.assertNotIn("Ranní stav", COCKPIT_HTML)
    ...
    def test_cockpit_dev_runner_run_action_reports_failed_command(self) -> None:
        ...
        self.assertIn("Vyřešit ve ScanDocu", COCKPIT_HTML)
        self.assertIn("openScanDocuReview", COCKPIT_HTML)
        self.assertNotIn("updateDocumentReviewMetadata", COCKPIT_HTML)
        self.assertNotIn("acceptDocumentReviewMetadataSuggestion", COCKPIT_HTML)
