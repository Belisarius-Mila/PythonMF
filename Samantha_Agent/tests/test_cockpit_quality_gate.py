...
"""
    ...
    def test_quality_gate_manifest_paths_and_modules_are_unique(self) -> None:
        ...
        self.assertIn("tests.test_camino_receiver", TEST_MODULES)
        self.assertIn("tests.test_camino_chunk_receiver", TEST_MODULES)
        self.assertIn("tests.test_camino_c05a_media_store", TEST_MODULES)
        self.assertIn("tests.test_camino_c05a_loopback_smoke", TEST_MODULES)
        self.assertIn("tests.test_camino_c02b_t043_control", TEST_MODULES)
        ...
        self.assertIn("camino/server/media_store.py", COMPILE_PATHS)
        self.assertIn("camino/server/application.py", COMPILE_PATHS)
        self.assertIn("scripts/camino_c05a_loopback_smoke.py", COMPILE_PATHS)
        ...
        self.assertIn("tests.test_workflow_commands", TEST_MODULES)
        ...
        self.assertIn("app/workflows/commands.py", COMPILE_PATHS)
