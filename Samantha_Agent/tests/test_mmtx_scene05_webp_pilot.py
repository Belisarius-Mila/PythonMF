...
class MmtxScene05WebpPilotTests(unittest.TestCase):
    ...
    def test_scene_page_uses_approved_smooth_bridge_supports_and_final_webp(self) -> None:
        page = (DOCS_SCENE / "index.html").read_text(encoding="utf-8")

        self.assertIn(
            '<source srcset="scene05_log_bridge_supports_smooth_q90.webp" type="image/webp">',
            page,
        )
