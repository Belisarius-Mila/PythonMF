...
class CapabilityAuditTests(unittest.TestCase):
    def test_capability_audit_reports_mapped_tools_and_workflow_count(self) -> None:
        ...
        self.assertIn("Capability registry records: 66", text)
        self.assertIn("High-risk capability records: 15", text)
        self.assertIn("Registry-covered agent tools: 63/", text)
        ...
        self.assertIn("Read-only or low-risk missing records: 18", text)
        ...
        self.assertIn("- Read-only or low-risk: 18", text)
