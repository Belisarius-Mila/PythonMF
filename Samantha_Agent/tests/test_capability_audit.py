...
class CapabilityAuditTests(unittest.TestCase):
    def test_capability_audit_reports_mapped_tools_and_workflow_count(self) -> None:
        ...
        self.assertIn("Capability registry records: 61", text)
        self.assertIn("High-risk capability records: 15", text)
        self.assertIn("Registry-covered agent tools: 58/", text)
        ...
        self.assertIn("Read-only or low-risk missing records: 23", text)
        ...
        self.assertIn("- Read-only or low-risk: 23", text)
