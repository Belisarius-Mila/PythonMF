...
class CapabilityAuditTests(unittest.TestCase):
    def test_capability_audit_reports_mapped_tools_and_workflow_count(self) -> None:
        ...
        self.assertIn("Action/review missing records: 14", text)
        ...
        self.assertIn("- Action/review: 14", text)
        ...
        self.assertIn("- `prepare_iphone_shortcut`", text)
        self.assertIn("- `build_email_case_from_uid`", text)
